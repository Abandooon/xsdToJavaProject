...
public class AclOperation {
    ...
    protected ImpliedOperationRefs impliedOperationRefs;
    ...
    @XmlElement(name="IMPLIED-OPERATION-REFS")
    public ImpliedOperationRefs getImpliedOperationRefs() {
        return this.impliedOperationRefs;
    }

    public void setImpliedOperationRefs(ImpliedOperationRefs value) {
