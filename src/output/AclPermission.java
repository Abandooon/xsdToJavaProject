...
public class AclPermission {
    ...
    protected AclContexts aclContexts;
    
    
    
    protected AclObjectRefs aclObjectRefs;
    
    
    
    protected AclOperationRefs aclOperationRefs;
    
    
    
    protected AclRoleRefs aclRoleRefs;
    ...
    public AclContexts getAclContexts() {
        return this.aclContexts;
    }

    public void setAclContexts(AclContexts value) {
    ...
    public AclObjectRefs getAclObjectRefs() {
        return this.aclObjectRefs;
    }

    public void setAclObjectRefs(AclObjectRefs value) {
    ...
    public AclOperationRefs getAclOperationRefs() {
        return this.aclOperationRefs;
    }

    public void setAclOperationRefs(AclOperationRefs value) {
    ...
    public AclRoleRefs getAclRoleRefs() {
        return this.aclRoleRefs;
    }

    public void setAclRoleRefs(AclRoleRefs value) {
