...
public class ArPackage {
    ...
    protected ReferenceBases referenceBases;
    ...
    protected ArPackages arPackages;
    ...
    public ReferenceBases getReferenceBases() {
        return this.referenceBases;
    }

    public void setReferenceBases(ReferenceBases value) {
    ...
    public void setArPackages(ArPackages value) {
