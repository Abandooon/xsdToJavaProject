...
public class ArbitraryEventTriggering {
    ...
    protected MinimumDistances minimumDistances;
    
    
    
    protected MaximumDistances maximumDistances;
    
    
    
    protected ConfidenceIntervals confidenceIntervals;
    ...
    public MinimumDistances getMinimumDistances() {
        return this.minimumDistances;
    }

    public void setMinimumDistances(MinimumDistances value) {
    ...
    public void setMaximumDistances(MaximumDistances value) {
    ...
    public ConfidenceIntervals getConfidenceIntervals() {
        return this.confidenceIntervals;
    }

    public void setConfidenceIntervals(ConfidenceIntervals value) {
