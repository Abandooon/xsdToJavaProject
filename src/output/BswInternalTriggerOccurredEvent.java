...
public class BswInternalTriggerOccurredEvent {
    ...
    protected ContextLimitationRefs contextLimitationRefs;
    
    
    
    protected DisabledInModeIrefs disabledInModeIrefs;
    ...
    protected EventSourceRef eventSourceRef;
    ...
    public ContextLimitationRefs getContextLimitationRefs() {
        return this.contextLimitationRefs;
    }

    public void setContextLimitationRefs(ContextLimitationRefs value) {
    ...
    public DisabledInModeIrefs getDisabledInModeIrefs() {
        return this.disabledInModeIrefs;
    }

    public void setDisabledInModeIrefs(DisabledInModeIrefs value) {
    ...
    public EventSourceRef getEventSourceRef() {
        return this.eventSourceRef;
    }

    public void setEventSourceRef(EventSourceRef value) {
