...
public class BuildActionManifest {
    ...
    protected StartActionRefs startActionRefs;
    
    
    
    protected TearDownActionRefs tearDownActionRefs;
    
    
    
    protected BuildActions buildActions;
    
    
    
    protected BuildActionEnvironments buildActionEnvironments;
    
    
    
    protected DynamicActionRefs dynamicActionRefs;
    ...
    public StartActionRefs getStartActionRefs() {
        return this.startActionRefs;
    }

    public void setStartActionRefs(StartActionRefs value) {
    ...
    public TearDownActionRefs getTearDownActionRefs() {
        return this.tearDownActionRefs;
    }

    public void setTearDownActionRefs(TearDownActionRefs value) {
    ...
    public BuildActions getBuildActions() {
        return this.buildActions;
    }

    public void setBuildActions(BuildActions value) {
    ...
    public BuildActionEnvironments getBuildActionEnvironments() {
        return this.buildActionEnvironments;
    }

    public void setBuildActionEnvironments(BuildActionEnvironments value) {
    ...
    public DynamicActionRefs getDynamicActionRefs() {
        return this.dynamicActionRefs;
    }

    public void setDynamicActionRefs(DynamicActionRefs value) {
