...
public class ClientServerInterface {
    ...
    protected PossibleErrors possibleErrors;
    ...
    @XmlElement(name="POSSIBLE-ERRORS")
    public PossibleErrors getPossibleErrors() {
        return this.possibleErrors;
    }

    public void setPossibleErrors(PossibleErrors value) {
