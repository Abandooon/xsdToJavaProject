...
public class ClientServerInterfaceMapping {
    ...
    protected ErrorMappings errorMappings;
    
    
    
    protected OperationMappings operationMappings;
    ...
    @XmlElement(name="ERROR-MAPPINGS")
    public ErrorMappings getErrorMappings() {
        return this.errorMappings;
    }

    public void setErrorMappings(ErrorMappings value) {
        this.errorMappings = value;
    }
    
    
    
    @XmlElement(name="OPERATION-MAPPINGS")
    public OperationMappings getOperationMappings() {
        return this.operationMappings;
    }

    public void setOperationMappings(OperationMappings value) {
