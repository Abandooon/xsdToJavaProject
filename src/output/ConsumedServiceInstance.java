...
public class ConsumedServiceInstance {
    ...
    protected ConsumedEventGroups consumedEventGroups;
    
    
    
    protected ProvidedServiceInstanceRef providedServiceInstanceRef;
    ...
    public ConsumedEventGroups getConsumedEventGroups() {
        return this.consumedEventGroups;
    }

    public void setConsumedEventGroups(ConsumedEventGroups value) {
    ...
    public ProvidedServiceInstanceRef getProvidedServiceInstanceRef() {
        return this.providedServiceInstanceRef;
    }

    public void setProvidedServiceInstanceRef(ProvidedServiceInstanceRef value) {
