...
public class CouplingPort {
    ...
    protected MacMulticastAddressRefs macMulticastAddressRefs;
    ...
    protected VlanMemberships vlanMemberships;
    ...
    public MacMulticastAddressRefs getMacMulticastAddressRefs() {
        return this.macMulticastAddressRefs;
    }

    public void setMacMulticastAddressRefs(MacMulticastAddressRefs value) {
    ...
    public VlanMemberships getVlanMemberships() {
        return this.vlanMemberships;
    }

    public void setVlanMemberships(VlanMemberships value) {
