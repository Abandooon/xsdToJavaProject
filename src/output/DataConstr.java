...
public class DataConstr {
    ...
    protected DataConstrRules dataConstrRules;
    ...
    @XmlElement(name="DATA-CONSTR-RULES")
    public DataConstrRules getDataConstrRules() {
        return this.dataConstrRules;
    }

    public void setDataConstrRules(DataConstrRules value) {
