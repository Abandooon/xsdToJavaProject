...
public class DataTypeMappingSet {
    ...
    protected DataTypeMaps dataTypeMaps;
    
    
    
    protected ModeRequestTypeMaps modeRequestTypeMaps;
    ...
    @XmlElement(name="DATA-TYPE-MAPS")
    public DataTypeMaps getDataTypeMaps() {
        return this.dataTypeMaps;
    }

    public void setDataTypeMaps(DataTypeMaps value) {
        this.dataTypeMaps = value;
    }
    
    
    
    @XmlElement(name="MODE-REQUEST-TYPE-MAPS")
    public ModeRequestTypeMaps getModeRequestTypeMaps() {
        return this.modeRequestTypeMaps;
    }

    public void setModeRequestTypeMaps(ModeRequestTypeMaps value) {
