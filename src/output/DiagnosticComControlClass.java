...
public class DiagnosticComControlClass {
    ...
    protected SpecificChannels specificChannels;
    
    
    
    protected SubNodeChannels subNodeChannels;
    ...
    @XmlElement(name="SPECIFIC-CHANNELS")
    public SpecificChannels getSpecificChannels() {
        return this.specificChannels;
    }

    public void setSpecificChannels(SpecificChannels value) {
        this.specificChannels = value;
    }
    
    
    
    @XmlElement(name="SUB-NODE-CHANNELS")
    public SubNodeChannels getSubNodeChannels() {
        return this.subNodeChannels;
    }

    public void setSubNodeChannels(SubNodeChannels value) {
