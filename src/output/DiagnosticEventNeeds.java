...
public class DiagnosticEventNeeds {
    ...
    protected DeferringFidRefs deferringFidRefs;
    ...
    protected InhibitingSecondaryFidRefs inhibitingSecondaryFidRefs;
    ...
    public DeferringFidRefs getDeferringFidRefs() {
        return this.deferringFidRefs;
    }

    public void setDeferringFidRefs(DeferringFidRefs value) {
    ...
    public InhibitingSecondaryFidRefs getInhibitingSecondaryFidRefs() {
        return this.inhibitingSecondaryFidRefs;
    }

    public void setInhibitingSecondaryFidRefs(InhibitingSecondaryFidRefs value) {
