...
public class DiagnosticServiceSwMapping {
    ...
    protected ServiceInstanceRef serviceInstanceRef;
    ...
    public ServiceInstanceRef getServiceInstanceRef() {
        return this.serviceInstanceRef;
    }

    public void setServiceInstanceRef(ServiceInstanceRef value) {
