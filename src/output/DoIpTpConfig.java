...
public class DoIpTpConfig {
    ...
    protected DoIpLogicAddresss doIpLogicAddresss;
    ...
    @XmlElement(name="DO-IP-LOGIC-ADDRESSS")
    public DoIpLogicAddresss getDoIpLogicAddresss() {
        return this.doIpLogicAddresss;
    }

    public void setDoIpLogicAddresss(DoIpLogicAddresss value) {
