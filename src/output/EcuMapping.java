...
public class EcuMapping {
    ...
    protected CommControllerMappings commControllerMappings;
    ...
    protected HwPortMappings hwPortMappings;
    ...
    public CommControllerMappings getCommControllerMappings() {
        return this.commControllerMappings;
    }

    public void setCommControllerMappings(CommControllerMappings value) {
    ...
    public HwPortMappings getHwPortMappings() {
        return this.hwPortMappings;
    }

    public void setHwPortMappings(HwPortMappings value) {
