...
public class EcucChoiceReferenceDef {
    ...
    protected DestinationRefs destinationRefs;
    ...
    @XmlElement(name="DESTINATION-REFS")
    public DestinationRefs getDestinationRefs() {
        return this.destinationRefs;
    }

    public void setDestinationRefs(DestinationRefs value) {
