...
public class EcucDefinitionCollection {
    ...
    protected ModuleRefs moduleRefs;
    ...
    @XmlElement(name="MODULE-REFS")
    public ModuleRefs getModuleRefs() {
        return this.moduleRefs;
    }

    public void setModuleRefs(ModuleRefs value) {
