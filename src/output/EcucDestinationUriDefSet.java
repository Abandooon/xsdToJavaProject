...
public class EcucDestinationUriDefSet {
    ...
    protected DestinationUriDefs destinationUriDefs;
    ...
    @XmlElement(name="DESTINATION-URI-DEFS")
    public DestinationUriDefs getDestinationUriDefs() {
        return this.destinationUriDefs;
    }

    public void setDestinationUriDefs(DestinationUriDefs value) {
