...
public class EcucLinkerSymbolDef {
    ...
    protected EcucLinkerSymbolDefVariants ecucLinkerSymbolDefVariants;
    ...
    @XmlElement(name="ECUC-LINKER-SYMBOL-DEF-VARIANTS")
    public EcucLinkerSymbolDefVariants getEcucLinkerSymbolDefVariants() {
        return this.ecucLinkerSymbolDefVariants;
    }

    public void setEcucLinkerSymbolDefVariants(EcucLinkerSymbolDefVariants value) {
