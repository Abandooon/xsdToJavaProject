...
public class EcucMultilineStringParamDef {
    ...
    protected EcucMultilineStringParamDefVariants ecucMultilineStringParamDefVariants;
    ...
    @XmlElement(name="ECUC-MULTILINE-STRING-PARAM-DEF-VARIANTS")
    public EcucMultilineStringParamDefVariants getEcucMultilineStringParamDefVariants() {
        return this.ecucMultilineStringParamDefVariants;
    }

    public void setEcucMultilineStringParamDefVariants(EcucMultilineStringParamDefVariants value) {
