...
public class EthernetClusterConditional {
    ...
    protected CouplingPortConnections couplingPortConnections;
    
    
    
    protected MacMulticastGroups macMulticastGroups;
    ...
    public CouplingPortConnections getCouplingPortConnections() {
        return this.couplingPortConnections;
    }

    public void setCouplingPortConnections(CouplingPortConnections value) {
    ...
    public MacMulticastGroups getMacMulticastGroups() {
        return this.macMulticastGroups;
    }

    public void setMacMulticastGroups(MacMulticastGroups value) {
