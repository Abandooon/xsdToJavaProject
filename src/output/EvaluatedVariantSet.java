...
public class EvaluatedVariantSet {
    ...
    protected EvaluatedElementRefs evaluatedElementRefs;
    
    
    
    protected EvaluatedVariantRefs evaluatedVariantRefs;
    ...
    public EvaluatedElementRefs getEvaluatedElementRefs() {
        return this.evaluatedElementRefs;
    }

    public void setEvaluatedElementRefs(EvaluatedElementRefs value) {
    ...
    public EvaluatedVariantRefs getEvaluatedVariantRefs() {
        return this.evaluatedVariantRefs;
    }

    public void setEvaluatedVariantRefs(EvaluatedVariantRefs value) {
