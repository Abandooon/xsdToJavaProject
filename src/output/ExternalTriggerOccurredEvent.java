...
public class ExternalTriggerOccurredEvent {
    ...
    protected RTriggerInAtomicSwcInstanceRef triggerIref;
    ...
    public RTriggerInAtomicSwcInstanceRef getTriggerIref() {
        return this.triggerIref;
    }

    public void setTriggerIref(RTriggerInAtomicSwcInstanceRef value) {
