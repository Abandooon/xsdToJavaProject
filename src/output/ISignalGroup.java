...
public class ISignalGroup {
    ...
    protected ComBasedSignalGroupTransformations comBasedSignalGroupTransformations;
    
    
    
    protected ISignalRefs iSignalRefs;
    ...
    public ComBasedSignalGroupTransformations getComBasedSignalGroupTransformations() {
        return this.comBasedSignalGroupTransformations;
    }

    public void setComBasedSignalGroupTransformations(ComBasedSignalGroupTransformations value) {
    ...
    public ISignalRefs getISignalRefs() {
        return this.iSignalRefs;
    }

    public void setISignalRefs(ISignalRefs value) {
