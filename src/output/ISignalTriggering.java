...
public class ISignalTriggering {
    ...
    protected ISignalPortRefs iSignalPortRefs;
    ...
    @XmlElement(name="I-SIGNAL-PORT-REFS")
    public ISignalPortRefs getISignalPortRefs() {
        return this.iSignalPortRefs;
    }

    public void setISignalPortRefs(ISignalPortRefs value) {
