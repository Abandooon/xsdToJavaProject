...
public class LParagraph {
    ...
    protected ArrayList<Stds> stdss;
    
    
    
    protected ArrayList<Xdocs> xdocss;
    
    
    
    protected ArrayList<Xfiles> xfiless;
    ...
    @XmlElement(name="STD")
    public ArrayList<Stds> getStdss() {
        return this.stdss;
    }

    public void setStdss(ArrayList<Stds> value) {
        this.stdss = value;
    }
    ...
    public ArrayList<Xdocs> getXdocss() {
        return this.xdocss;
    }

    public void setXdocss(ArrayList<Xdocs> value) {
        this.xdocss = value;
    }
    ...
    public ArrayList<Xfiles> getXfiless() {
        return this.xfiless;
    }

    public void setXfiless(ArrayList<Xfiles> value) {
        this.xfiless = value;
    }
