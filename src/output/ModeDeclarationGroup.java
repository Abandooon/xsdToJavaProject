...
public class ModeDeclarationGroup {
    ...
    protected ModeDeclarations modeDeclarations;
    ...
    protected ModeTransitions modeTransitions;
    ...
    public void setModeDeclarations(ModeDeclarations value) {
    ...
    public ModeTransitions getModeTransitions() {
        return this.modeTransitions;
    }

    public void setModeTransitions(ModeTransitions value) {
