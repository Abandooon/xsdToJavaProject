...
public class PduTriggering {
    ...
    protected IPduPortRefs iPduPortRefs;
    ...
    protected TriggerIPduSendConditions triggerIPduSendConditions;
    ...
    public IPduPortRefs getIPduPortRefs() {
        return this.iPduPortRefs;
    }

    public void setIPduPortRefs(IPduPortRefs value) {
    ...
    @XmlElement(name="TRIGGER-I-PDU-SEND-CONDITIONS")
    public TriggerIPduSendConditions getTriggerIPduSendConditions() {
        return this.triggerIPduSendConditions;
    }

    public void setTriggerIPduSendConditions(TriggerIPduSendConditions value) {
