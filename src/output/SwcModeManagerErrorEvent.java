...
public class SwcModeManagerErrorEvent {
    ...
    protected PModeGroupInAtomicSwcInstanceRef modeGroupIref;
    ...
    public PModeGroupInAtomicSwcInstanceRef getModeGroupIref() {
        return this.modeGroupIref;
    }

    public void setModeGroupIref(PModeGroupInAtomicSwcInstanceRef value) {
