...
public class SynchronizationTimingConstraint {
    ...
    protected ScopeEventRefs scopeEventRefs;
    
    
    
    protected ScopeRefs scopeRefs;
    ...
    public ScopeEventRefs getScopeEventRefs() {
        return this.scopeEventRefs;
    }

    public void setScopeEventRefs(ScopeEventRefs value) {
    ...
    public ScopeRefs getScopeRefs() {
        return this.scopeRefs;
    }

    public void setScopeRefs(ScopeRefs value) {
