...
public class TransformerHardErrorEvent {
    ...
    protected DisabledModeIrefs disabledModeIrefs;
    ...
    protected PTriggerInAtomicSwcTypeInstanceRef triggerIref;
    ...
    public DisabledModeIrefs getDisabledModeIrefs() {
        return this.disabledModeIrefs;
    }

    public void setDisabledModeIrefs(DisabledModeIrefs value) {
    ...
    public PTriggerInAtomicSwcTypeInstanceRef getTriggerIref() {
        return this.triggerIref;
    }

    public void setTriggerIref(PTriggerInAtomicSwcTypeInstanceRef value) {
