...
public class TriggerInterfaceMapping {
    ...
    protected TriggerMappings triggerMappings;
    ...
    @XmlElement(name="TRIGGER-MAPPINGS")
    public TriggerMappings getTriggerMappings() {
        return this.triggerMappings;
    }

    public void setTriggerMappings(TriggerMappings value) {
