...
public class AffectedRefWrapper {

    
    
    private AffectedRef affectedRef;

    public AffectedRefWrapper(AffectedRef affectedRef) {
    ...
    public EcucCommonAttributesSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(affectedRef.getDest())) {
            
            return affectedRef.getDest();
    ...
    public Object getAffectedRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = affectedRef.getValue();
        java.lang.String type = affectedRef.getDest().toString().replace("_", "-");
