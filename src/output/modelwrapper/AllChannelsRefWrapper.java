...
public class AllChannelsRefWrapper {

    
    
    private AllChannelsRef allChannelsRef;

    public AllChannelsRefWrapper(AllChannelsRef allChannelsRef) {
        this.allChannelsRef = allChannelsRef;
    }

   
    public CommunicationClusterSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(allChannelsRef.getDest())) {
            
            return allChannelsRef.getDest();
    ...
    public Object getAllChannelsRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = allChannelsRef.getValue();
        java.lang.String type = allChannelsRef.getDest().toString().replace("_", "-");
