...
public class ApplicationDataTypeRefWrapper {

    
    
    private ApplicationDataTypeRef applicationDataTypeRef;

    public ApplicationDataTypeRefWrapper(ApplicationDataTypeRef applicationDataTypeRef) {
        this.applicationDataTypeRef = applicationDataTypeRef;
    }

   
    public ApplicationDataTypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(applicationDataTypeRef.getDest())) {
            
            return applicationDataTypeRef.getDest();
    ...
    public Object getApplicationDataTypeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = applicationDataTypeRef.getValue();
        java.lang.String type = applicationDataTypeRef.getDest().toString().replace("_", "-");
