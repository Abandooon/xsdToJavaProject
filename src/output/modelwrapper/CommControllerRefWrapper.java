...
public class CommControllerRefWrapper {

    
    
    private CommControllerRef commControllerRef;

    public CommControllerRefWrapper(CommControllerRef commControllerRef) {
        this.commControllerRef = commControllerRef;
    }

   
    public CommunicationControllerSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(commControllerRef.getDest())) {
            
            return commControllerRef.getDest();
    ...
    public Object getCommControllerRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = commControllerRef.getValue();
        java.lang.String type = commControllerRef.getDest().toString().replace("_", "-");
