...
public class CommunicationClusterRefWrapper {

    
    
    private CommunicationClusterRef communicationClusterRef;

    public CommunicationClusterRefWrapper(CommunicationClusterRef communicationClusterRef) {
        this.communicationClusterRef = communicationClusterRef;
    }

   
    public CommunicationClusterSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(communicationClusterRef.getDest())) {
            
            return communicationClusterRef.getDest();
    ...
    public Object getCommunicationClusterRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = communicationClusterRef.getValue();
        java.lang.String type = communicationClusterRef.getDest().toString().replace("_", "-");
