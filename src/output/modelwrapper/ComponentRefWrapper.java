...
public class ComponentRefWrapper {

    
    
    private ComponentRef componentRef;

    public ComponentRefWrapper(ComponentRef componentRef) {
    ...
    public SwComponentTypeSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(componentRef.getDest())) {
            
            return componentRef.getDest();
    ...
    public Object getComponentRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = componentRef.getValue();
        java.lang.String type = componentRef.getDest().toString().replace("_", "-");
