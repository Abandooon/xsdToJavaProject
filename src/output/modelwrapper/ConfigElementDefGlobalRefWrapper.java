...
public class ConfigElementDefGlobalRefWrapper {

    
    
    private ConfigElementDefGlobalRef configElementDefGlobalRef;

    public ConfigElementDefGlobalRefWrapper(ConfigElementDefGlobalRef configElementDefGlobalRef) {
        this.configElementDefGlobalRef = configElementDefGlobalRef;
    }

   
    public EcucDefinitionElementSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(configElementDefGlobalRef.getDest())) {
            
            return configElementDefGlobalRef.getDest();
    ...
    public Object getConfigElementDefGlobalRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = configElementDefGlobalRef.getValue();
        java.lang.String type = configElementDefGlobalRef.getDest().toString().replace("_", "-");
