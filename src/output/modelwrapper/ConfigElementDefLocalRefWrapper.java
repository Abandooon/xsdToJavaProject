...
public class ConfigElementDefLocalRefWrapper {

    
    
    private ConfigElementDefLocalRef configElementDefLocalRef;

    public ConfigElementDefLocalRefWrapper(ConfigElementDefLocalRef configElementDefLocalRef) {
        this.configElementDefLocalRef = configElementDefLocalRef;
    }

   
    public EcucDefinitionElementSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(configElementDefLocalRef.getDest())) {
            
            return configElementDefLocalRef.getDest();
    ...
    public Object getConfigElementDefLocalRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = configElementDefLocalRef.getValue();
        java.lang.String type = configElementDefLocalRef.getDest().toString().replace("_", "-");
