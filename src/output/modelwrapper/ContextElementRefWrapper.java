...
public class ContextElementRefWrapper {

    
    
    private ContextElementRef contextElementRef;

    public ContextElementRefWrapper(ContextElementRef contextElementRef) {
        this.contextElementRef = contextElementRef;
    }

   
    public AtpFeatureSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(contextElementRef.getDest())) {
            
            return contextElementRef.getDest();
    ...
    public Object getContextElementRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = contextElementRef.getValue();
        java.lang.String type = contextElementRef.getDest().toString().replace("_", "-");
