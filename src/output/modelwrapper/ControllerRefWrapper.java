...
public class ControllerRefWrapper {

    
    
    private ControllerRef controllerRef;

    public ControllerRefWrapper(ControllerRef controllerRef) {
    ...
    public CommunicationControllerSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(controllerRef.getDest())) {
            
            return controllerRef.getDest();
    ...
    public Object getControllerRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = controllerRef.getValue();
        java.lang.String type = controllerRef.getDest().toString().replace("_", "-");
