...
public class DataPrototypeRefWrapper {

    
    
    private DataPrototypeRef dataPrototypeRef;

    public DataPrototypeRefWrapper(DataPrototypeRef dataPrototypeRef) {
        this.dataPrototypeRef = dataPrototypeRef;
    }

   
    public AutosarDataPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(dataPrototypeRef.getDest())) {
            
            return dataPrototypeRef.getDest();
    ...
    public Object getDataPrototypeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = dataPrototypeRef.getValue();
        java.lang.String type = dataPrototypeRef.getDest().toString().replace("_", "-");
