...
public class DefinitionRefWrapper {

    
    
    private DefinitionRef definitionRef;

    public DefinitionRefWrapper(DefinitionRef definitionRef) {
    ...
    public EcucContainerDefSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(definitionRef.getDest())) {
            
            return definitionRef.getDest();
    ...
    public Object getDefinitionRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = definitionRef.getValue();
        java.lang.String type = definitionRef.getDest().toString().replace("_", "-");
