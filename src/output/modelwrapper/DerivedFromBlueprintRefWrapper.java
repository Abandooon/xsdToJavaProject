...
public class DerivedFromBlueprintRefWrapper {

    
    
    private DerivedFromBlueprintRef derivedFromBlueprintRef;

    public DerivedFromBlueprintRefWrapper(DerivedFromBlueprintRef derivedFromBlueprintRef) {
        this.derivedFromBlueprintRef = derivedFromBlueprintRef;
    }

   
    public AtpBlueprintSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(derivedFromBlueprintRef.getDest())) {
            
            return derivedFromBlueprintRef.getDest();
    ...
    public Object getDerivedFromBlueprintRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = derivedFromBlueprintRef.getValue();
        java.lang.String type = derivedFromBlueprintRef.getDest().toString().replace("_", "-");
