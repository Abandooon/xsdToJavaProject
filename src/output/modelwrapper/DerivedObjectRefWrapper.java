...
public class DerivedObjectRefWrapper {

    
    
    private DerivedObjectRef derivedObjectRef;

    public DerivedObjectRefWrapper(DerivedObjectRef derivedObjectRef) {
        this.derivedObjectRef = derivedObjectRef;
    }

   
    public AtpBlueprintableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(derivedObjectRef.getDest())) {
            
            return derivedObjectRef.getDest();
    ...
    public Object getDerivedObjectRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = derivedObjectRef.getValue();
        java.lang.String type = derivedObjectRef.getDest().toString().replace("_", "-");
