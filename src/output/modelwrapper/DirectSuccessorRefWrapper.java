...
public class DirectSuccessorRefWrapper {

    
    
    private DirectSuccessorRef directSuccessorRef;

    public DirectSuccessorRefWrapper(DirectSuccessorRef directSuccessorRef) {
        this.directSuccessorRef = directSuccessorRef;
    }

   
    public EocExecutableEntityRefAbstractSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(directSuccessorRef.getDest())) {
            
            return directSuccessorRef.getDest();
    ...
    public Object getDirectSuccessorRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = directSuccessorRef.getValue();
        java.lang.String type = directSuccessorRef.getDest().toString().replace("_", "-");
