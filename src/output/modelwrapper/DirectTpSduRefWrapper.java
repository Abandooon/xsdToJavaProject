...
public class DirectTpSduRefWrapper {

    
    
    private DirectTpSduRef directTpSduRef;

    public DirectTpSduRefWrapper(DirectTpSduRef directTpSduRef) {
        this.directTpSduRef = directTpSduRef;
    }

   
    public IPduSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(directTpSduRef.getDest())) {
            
            return directTpSduRef.getDest();
    ...
    public Object getDirectTpSduRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = directTpSduRef.getValue();
        java.lang.String type = directTpSduRef.getDest().toString().replace("_", "-");
