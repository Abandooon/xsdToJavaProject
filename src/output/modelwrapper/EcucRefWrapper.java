...
public class EcucRefWrapper {

    
    
    private EcucRef ecucRef;

    public EcucRefWrapper(EcucRef ecucRef) {
        this.ecucRef = ecucRef;
    }

   
    public EcucDefinitionElementSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(ecucRef.getDest())) {
            
            return ecucRef.getDest();
    ...
    public Object getEcucRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = ecucRef.getValue();
        java.lang.String type = ecucRef.getDest().toString().replace("_", "-");
