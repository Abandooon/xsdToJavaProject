...
public class EventRefWrapper {
    ...
    public EventRefWrapper(EventRef eventRef) {
    ...
    public TimingDescriptionEventSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(eventRef.getDest())) {
            
            return eventRef.getDest();
    ...
    public Object getEventRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = eventRef.getValue();
        java.lang.String type = eventRef.getDest().toString().replace("_", "-");
