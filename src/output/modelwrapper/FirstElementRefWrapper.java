...
public class FirstElementRefWrapper {

    
    
    private FirstElementRef firstElementRef;

    public FirstElementRefWrapper(FirstElementRef firstElementRef) {
        this.firstElementRef = firstElementRef;
    }

   
    public ReferrableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(firstElementRef.getDest())) {
            
            return firstElementRef.getDest();
    ...
    public Object getFirstElementRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = firstElementRef.getValue();
        java.lang.String type = firstElementRef.getDest().toString().replace("_", "-");
