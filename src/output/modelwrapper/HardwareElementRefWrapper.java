...
public class HardwareElementRefWrapper {

    
    
    private HardwareElementRef hardwareElementRef;

    public HardwareElementRefWrapper(HardwareElementRef hardwareElementRef) {
        this.hardwareElementRef = hardwareElementRef;
    }

   
    public HwDescriptionEntitySubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(hardwareElementRef.getDest())) {
            
            return hardwareElementRef.getDest();
    ...
    public Object getHardwareElementRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = hardwareElementRef.getValue();
        java.lang.String type = hardwareElementRef.getDest().toString().replace("_", "-");
