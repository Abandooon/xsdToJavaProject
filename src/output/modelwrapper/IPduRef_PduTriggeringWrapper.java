...
public class IPduRef_PduTriggeringWrapper {

    
    
    private IPduRef_PduTriggering iPduRef_PduTriggering;

    public IPduRef_PduTriggeringWrapper(IPduRef_PduTriggering iPduRef_PduTriggering) {
        this.iPduRef_PduTriggering = iPduRef_PduTriggering;
    }

   
    public PduSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(iPduRef_PduTriggering.getDest())) {
            
            return iPduRef_PduTriggering.getDest();
    ...
    public Object getIPduRef_PduTriggeringObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = iPduRef_PduTriggering.getValue();
        java.lang.String type = iPduRef_PduTriggering.getDest().toString().replace("_", "-");
