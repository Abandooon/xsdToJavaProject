...
public class IPduRef_TdEventIPduWrapper {

    
    
    private IPduRef_TdEventIPdu iPduRef_TdEventIPdu;

    public IPduRef_TdEventIPduWrapper(IPduRef_TdEventIPdu iPduRef_TdEventIPdu) {
        this.iPduRef_TdEventIPdu = iPduRef_TdEventIPdu;
    }

   
    public IPduSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(iPduRef_TdEventIPdu.getDest())) {
            
            return iPduRef_TdEventIPdu.getDest();
    ...
    public Object getIPduRef_TdEventIPduObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = iPduRef_TdEventIPdu.getValue();
        java.lang.String type = iPduRef_TdEventIPdu.getDest().toString().replace("_", "-");
