...
public class IdentifiableRefWrapper {

    
    
    private IdentifiableRef identifiableRef;

    public IdentifiableRefWrapper(IdentifiableRef identifiableRef) {
        this.identifiableRef = identifiableRef;
    }

   
    public IdentifiableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(identifiableRef.getDest())) {
            
            return identifiableRef.getDest();
    ...
    public Object getIdentifiableRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = identifiableRef.getValue();
        java.lang.String type = identifiableRef.getDest().toString().replace("_", "-");
