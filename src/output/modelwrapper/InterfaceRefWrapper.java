...
public class InterfaceRefWrapper {

    
    
    private InterfaceRef interfaceRef;

    public InterfaceRefWrapper(InterfaceRef interfaceRef) {
    ...
    public PortInterfaceSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(interfaceRef.getDest())) {
            
            return interfaceRef.getDest();
    ...
    public Object getInterfaceRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = interfaceRef.getValue();
        java.lang.String type = interfaceRef.getDest().toString().replace("_", "-");
