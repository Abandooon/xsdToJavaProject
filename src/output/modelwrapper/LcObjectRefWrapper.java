...
public class LcObjectRefWrapper {

    
    
    private LcObjectRef lcObjectRef;

    public LcObjectRefWrapper(LcObjectRef lcObjectRef) {
        this.lcObjectRef = lcObjectRef;
    }

   
    public ReferrableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(lcObjectRef.getDest())) {
            
            return lcObjectRef.getDest();
    ...
    public Object getLcObjectRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = lcObjectRef.getValue();
        java.lang.String type = lcObjectRef.getDest().toString().replace("_", "-");
