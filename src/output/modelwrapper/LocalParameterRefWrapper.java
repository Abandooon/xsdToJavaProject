...
public class LocalParameterRefWrapper {

    
    
    private LocalParameterRef localParameterRef;

    public LocalParameterRefWrapper(LocalParameterRef localParameterRef) {
        this.localParameterRef = localParameterRef;
    }

   
    public DataPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(localParameterRef.getDest())) {
            
            return localParameterRef.getDest();
    ...
    public Object getLocalParameterRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = localParameterRef.getValue();
        java.lang.String type = localParameterRef.getDest().toString().replace("_", "-");
