...
public class ObjectDefinitionRefWrapper {

    
    
    private ObjectDefinitionRef objectDefinitionRef;

    public ObjectDefinitionRefWrapper(ObjectDefinitionRef objectDefinitionRef) {
        this.objectDefinitionRef = objectDefinitionRef;
    }

   
    public AtpDefinitionSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(objectDefinitionRef.getDest())) {
            
            return objectDefinitionRef.getDest();
    ...
    public Object getObjectDefinitionRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = objectDefinitionRef.getValue();
        java.lang.String type = objectDefinitionRef.getDest().toString().replace("_", "-");
