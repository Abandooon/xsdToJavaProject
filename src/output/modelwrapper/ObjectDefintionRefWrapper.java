...
public class ObjectDefintionRefWrapper {

    
    
    private ObjectDefintionRef objectDefintionRef;

    public ObjectDefintionRefWrapper(ObjectDefintionRef objectDefintionRef) {
        this.objectDefintionRef = objectDefintionRef;
    }

   
    public AtpDefinitionSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(objectDefintionRef.getDest())) {
            
            return objectDefintionRef.getDest();
    ...
    public Object getObjectDefintionRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = objectDefintionRef.getValue();
        java.lang.String type = objectDefintionRef.getDest().toString().replace("_", "-");
