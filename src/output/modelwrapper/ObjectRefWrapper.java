...
public class ObjectRefWrapper {
    ...
    public ObjectRefWrapper(ObjectRef objectRef) {
    ...
    public ReferrableSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(objectRef.getDest())) {
            
            return objectRef.getDest();
    ...
    public Object getObjectRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = objectRef.getValue();
        java.lang.String type = objectRef.getDest().toString().replace("_", "-");
