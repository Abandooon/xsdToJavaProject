...
public class OuterPortRefWrapper {

    
    
    private OuterPortRef outerPortRef;

    public OuterPortRefWrapper(OuterPortRef outerPortRef) {
        this.outerPortRef = outerPortRef;
    }

   
    public PortPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(outerPortRef.getDest())) {
            
            return outerPortRef.getDest();
    ...
    public Object getOuterPortRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = outerPortRef.getValue();
        java.lang.String type = outerPortRef.getDest().toString().replace("_", "-");
