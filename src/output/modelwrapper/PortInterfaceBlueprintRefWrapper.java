...
public class PortInterfaceBlueprintRefWrapper {

    
    
    private PortInterfaceBlueprintRef portInterfaceBlueprintRef;

    public PortInterfaceBlueprintRefWrapper(PortInterfaceBlueprintRef portInterfaceBlueprintRef) {
        this.portInterfaceBlueprintRef = portInterfaceBlueprintRef;
    }

   
    public PortInterfaceSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(portInterfaceBlueprintRef.getDest())) {
            
            return portInterfaceBlueprintRef.getDest();
    ...
    public Object getPortInterfaceBlueprintRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = portInterfaceBlueprintRef.getValue();
        java.lang.String type = portInterfaceBlueprintRef.getDest().toString().replace("_", "-");
