...
public class PortPrototypeRefWrapper {

    
    
    private PortPrototypeRef portPrototypeRef;

    public PortPrototypeRefWrapper(PortPrototypeRef portPrototypeRef) {
        this.portPrototypeRef = portPrototypeRef;
    }

   
    public PortPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(portPrototypeRef.getDest())) {
            
            return portPrototypeRef.getDest();
    ...
    public Object getPortPrototypeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = portPrototypeRef.getValue();
        java.lang.String type = portPrototypeRef.getDest().toString().replace("_", "-");
