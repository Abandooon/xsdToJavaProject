...
public class ProvidedRequiredInterfaceTrefWrapper {

    
    
    private ProvidedRequiredInterfaceTref providedRequiredInterfaceTref;

    public ProvidedRequiredInterfaceTrefWrapper(ProvidedRequiredInterfaceTref providedRequiredInterfaceTref) {
        this.providedRequiredInterfaceTref = providedRequiredInterfaceTref;
    }

   
    public PortInterfaceSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(providedRequiredInterfaceTref.getDest())) {
            
            return providedRequiredInterfaceTref.getDest();
    ...
    public Object getProvidedRequiredInterfaceTrefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = providedRequiredInterfaceTref.getValue();
        java.lang.String type = providedRequiredInterfaceTref.getDest().toString().replace("_", "-");
