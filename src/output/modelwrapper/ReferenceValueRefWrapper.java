...
public class ReferenceValueRefWrapper {

    
    
    private ReferenceValueRef referenceValueRef;

    public ReferenceValueRefWrapper(ReferenceValueRef referenceValueRef) {
        this.referenceValueRef = referenceValueRef;
    }

   
    public DataPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(referenceValueRef.getDest())) {
            
            return referenceValueRef.getDest();
    ...
    public Object getReferenceValueRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = referenceValueRef.getValue();
        java.lang.String type = referenceValueRef.getDest().toString().replace("_", "-");
