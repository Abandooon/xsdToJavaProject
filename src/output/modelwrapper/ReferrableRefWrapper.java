...
public class ReferrableRefWrapper {

    
    
    private ReferrableRef referrableRef;

    public ReferrableRefWrapper(ReferrableRef referrableRef) {
        this.referrableRef = referrableRef;
    }

   
    public ReferrableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(referrableRef.getDest())) {
            
            return referrableRef.getDest();
    ...
    public Object getReferrableRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = referrableRef.getValue();
        java.lang.String type = referrableRef.getDest().toString().replace("_", "-");
