...
public class RequiredInterfaceTrefWrapper {

    
    
    private RequiredInterfaceTref requiredInterfaceTref;

    public RequiredInterfaceTrefWrapper(RequiredInterfaceTref requiredInterfaceTref) {
        this.requiredInterfaceTref = requiredInterfaceTref;
    }

   
    public PortInterfaceSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(requiredInterfaceTref.getDest())) {
            
            return requiredInterfaceTref.getDest();
    ...
    public Object getRequiredInterfaceTrefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = requiredInterfaceTref.getValue();
        java.lang.String type = requiredInterfaceTref.getDest().toString().replace("_", "-");
