...
public class ReversedTpSduRefWrapper {

    
    
    private ReversedTpSduRef reversedTpSduRef;

    public ReversedTpSduRefWrapper(ReversedTpSduRef reversedTpSduRef) {
        this.reversedTpSduRef = reversedTpSduRef;
    }

   
    public IPduSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(reversedTpSduRef.getDest())) {
            
            return reversedTpSduRef.getDest();
    ...
    public Object getReversedTpSduRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = reversedTpSduRef.getValue();
        java.lang.String type = reversedTpSduRef.getDest().toString().replace("_", "-");
