...
public class RootDataPrototypeRefWrapper {

    
    
    private RootDataPrototypeRef rootDataPrototypeRef;

    public RootDataPrototypeRefWrapper(RootDataPrototypeRef rootDataPrototypeRef) {
        this.rootDataPrototypeRef = rootDataPrototypeRef;
    }

   
    public AutosarDataPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(rootDataPrototypeRef.getDest())) {
            
            return rootDataPrototypeRef.getDest();
    ...
    public Object getRootDataPrototypeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = rootDataPrototypeRef.getValue();
        java.lang.String type = rootDataPrototypeRef.getDest().toString().replace("_", "-");
