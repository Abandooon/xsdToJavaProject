...
public class ScopeEventRefWrapper {

    
    
    private ScopeEventRef scopeEventRef;

    public ScopeEventRefWrapper(ScopeEventRef scopeEventRef) {
        this.scopeEventRef = scopeEventRef;
    }

   
    public TimingDescriptionEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(scopeEventRef.getDest())) {
            
            return scopeEventRef.getDest();
    ...
    public Object getScopeEventRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = scopeEventRef.getValue();
        java.lang.String type = scopeEventRef.getDest().toString().replace("_", "-");
