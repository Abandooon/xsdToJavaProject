...
public class ScopeRefWrapper {

    
    
    private ScopeRef scopeRef;

    public ScopeRefWrapper(ScopeRef scopeRef) {
    ...
    public TimingDescriptionEventSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(scopeRef.getDest())) {
            
            return scopeRef.getDest();
    ...
    public Object getScopeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = scopeRef.getValue();
        java.lang.String type = scopeRef.getDest().toString().replace("_", "-");
