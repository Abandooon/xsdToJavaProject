...
public class SduRefWrapper {

    
    
    private SduRef sduRef;

    public SduRefWrapper(SduRef sduRef) {
        this.sduRef = sduRef;
    }
    ...
    public IPduSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(sduRef.getDest())) {
            
            return sduRef.getDest();
    ...
    public Object getSduRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = sduRef.getValue();
        java.lang.String type = sduRef.getDest().toString().replace("_", "-");
