...
public class SdxRefWrapper {

    
    
    private SdxRef sdxRef;

    public SdxRefWrapper(SdxRef sdxRef) {
        this.sdxRef = sdxRef;
    }
    ...
    public ReferrableSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(sdxRef.getDest())) {
            
            return sdxRef.getDest();
    ...
    public Object getSdxRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = sdxRef.getValue();
        java.lang.String type = sdxRef.getDest().toString().replace("_", "-");
