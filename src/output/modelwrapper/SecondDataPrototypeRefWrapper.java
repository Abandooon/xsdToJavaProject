...
public class SecondDataPrototypeRefWrapper {

    
    
    private SecondDataPrototypeRef secondDataPrototypeRef;

    public SecondDataPrototypeRefWrapper(SecondDataPrototypeRef secondDataPrototypeRef) {
        this.secondDataPrototypeRef = secondDataPrototypeRef;
    }

   
    public AutosarDataPrototypeSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(secondDataPrototypeRef.getDest())) {
            
            return secondDataPrototypeRef.getDest();
    ...
    public Object getSecondDataPrototypeRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = secondDataPrototypeRef.getValue();
        java.lang.String type = secondDataPrototypeRef.getDest().toString().replace("_", "-");
