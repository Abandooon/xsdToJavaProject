...
public class SecondElementRefWrapper {

    
    
    private SecondElementRef secondElementRef;

    public SecondElementRefWrapper(SecondElementRef secondElementRef) {
        this.secondElementRef = secondElementRef;
    }

   
    public ReferrableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(secondElementRef.getDest())) {
            
            return secondElementRef.getDest();
    ...
    public Object getSecondElementRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
    ...
    public BswDirectCallPointWrapper getBswDirectCallPoint() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof BswDirectCallPoint){
            return new BswDirectCallPointWrapper((BswDirectCallPoint) queryObject);
        }else{
            return null;
        }
    ...
    public BswSynchronousServerCallPointWrapper getBswSynchronousServerCallPoint() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof BswSynchronousServerCallPoint){
            return new BswSynchronousServerCallPointWrapper((BswSynchronousServerCallPoint) queryObject);
        }else{
            return null;
        }
    ...
    public BswVariableAccessWrapper getBswVariableAccess() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof BswVariableAccess){
            return new BswVariableAccessWrapper((BswVariableAccess) queryObject);
        }else{
            return null;
        }
    ...
    public CaptionWrapper getCaption() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof Caption){
            return new CaptionWrapper((Caption) queryObject);
        }else{
            return null;
        }
    ...
    public CouplingPortTrafficClassAssignmentWrapper getCouplingPortTrafficClassAssignment() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof CouplingPortTrafficClassAssignment){
            return new CouplingPortTrafficClassAssignmentWrapper((CouplingPortTrafficClassAssignment) queryObject);
        }else{
            return null;
        }
    ...
    public DefItemWrapper getDefItem() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof DefItem){
            return new DefItemWrapper((DefItem) queryObject);
        }else{
            return null;
        }
    ...
    public DocumentationContextWrapper getDocumentationContext() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof DocumentationContext){
            return new DocumentationContextWrapper((DocumentationContext) queryObject);
        }else{
            return null;
        }
    ...
    public EthernetPriorityRegenerationWrapper getEthernetPriorityRegeneration() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof EthernetPriorityRegeneration){
            return new EthernetPriorityRegenerationWrapper((EthernetPriorityRegeneration) queryObject);
        }else{
            return null;
        }
    ...
    public EventHandlerWrapper getEventHandler() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof EventHandler){
            return new EventHandlerWrapper((EventHandler) queryObject);
        }else{
            return null;
        }
    ...
    public SocketConnectionBundleWrapper getSocketConnectionBundle() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof SocketConnectionBundle){
            return new SocketConnectionBundleWrapper((SocketConnectionBundle) queryObject);
        }else{
            return null;
        }
    ...
    public StdWrapper getStd() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof Std){
            return new StdWrapper((Std) queryObject);
        }else{
            return null;
        }
    ...
    public SymbolPropsWrapper getSymbolProps() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof SymbolProps){
            return new SymbolPropsWrapper((SymbolProps) queryObject);
        }else{
            return null;
        }
    ...
    public SymbolicNamePropsWrapper getSymbolicNameProps() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof SymbolicNameProps){
            return new SymbolicNamePropsWrapper((SymbolicNameProps) queryObject);
        }else{
            return null;
        }
    ...
    public XdocWrapper getXdoc() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof Xdoc){
            return new XdocWrapper((Xdoc) queryObject);
        }else{
            return null;
        }
    ...
    public XfileWrapper getXfile() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof Xfile){
            return new XfileWrapper((Xfile) queryObject);
        }else{
            return null;
        }
    ...
    public XrefTargetWrapper getXrefTarget() throws BaseXException, ClassNotFoundException, JAXBException{
        java.lang.String path = secondElementRef.getValue();
        java.lang.String type = secondElementRef.getDest().toString().replace("_", "-");
        SchemaController schemaController = (SchemaController) RestrictDTO.controllerMap.get("schemaController");
        Iproject currentProject = (Iproject) ApplicationContextUtil.applicationContext.get("currentProject");
        ...
        if(queryObject instanceof XrefTarget){
            return new XrefTargetWrapper((XrefTarget) queryObject);
        }else{
            return null;
        }
