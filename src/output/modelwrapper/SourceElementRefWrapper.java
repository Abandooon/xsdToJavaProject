...
public class SourceElementRefWrapper {

    
    
    private SourceElementRef sourceElementRef;

    public SourceElementRefWrapper(SourceElementRef sourceElementRef) {
        this.sourceElementRef = sourceElementRef;
    }

   
    public IdentifiableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(sourceElementRef.getDest())) {
            
            return sourceElementRef.getDest();
    ...
    public Object getSourceElementRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = sourceElementRef.getValue();
        java.lang.String type = sourceElementRef.getDest().toString().replace("_", "-");
