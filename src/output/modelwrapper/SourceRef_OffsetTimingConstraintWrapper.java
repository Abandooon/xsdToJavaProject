...
public class SourceRef_OffsetTimingConstraintWrapper {

    
    
    private SourceRef_OffsetTimingConstraint sourceRef_OffsetTimingConstraint;

    public SourceRef_OffsetTimingConstraintWrapper(SourceRef_OffsetTimingConstraint sourceRef_OffsetTimingConstraint) {
        this.sourceRef_OffsetTimingConstraint = sourceRef_OffsetTimingConstraint;
    }

   
    public TimingDescriptionEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(sourceRef_OffsetTimingConstraint.getDest())) {
            
            return sourceRef_OffsetTimingConstraint.getDest();
    ...
    public Object getSourceRef_OffsetTimingConstraintObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = sourceRef_OffsetTimingConstraint.getValue();
        java.lang.String type = sourceRef_OffsetTimingConstraint.getDest().toString().replace("_", "-");
