...
public class StimulusRefWrapper {

    
    
    private StimulusRef stimulusRef;

    public StimulusRefWrapper(StimulusRef stimulusRef) {
    ...
    public TimingDescriptionEventSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(stimulusRef.getDest())) {
            
            return stimulusRef.getDest();
    ...
    public Object getStimulusRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = stimulusRef.getValue();
        java.lang.String type = stimulusRef.getDest().toString().replace("_", "-");
