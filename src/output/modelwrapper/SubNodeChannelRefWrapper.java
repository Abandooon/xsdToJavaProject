...
public class SubNodeChannelRefWrapper {

    
    
    private SubNodeChannelRef subNodeChannelRef;

    public SubNodeChannelRefWrapper(SubNodeChannelRef subNodeChannelRef) {
        this.subNodeChannelRef = subNodeChannelRef;
    }

   
    public CommunicationClusterSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(subNodeChannelRef.getDest())) {
            
            return subNodeChannelRef.getDest();
    ...
    public Object getSubNodeChannelRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = subNodeChannelRef.getValue();
        java.lang.String type = subNodeChannelRef.getDest().toString().replace("_", "-");
