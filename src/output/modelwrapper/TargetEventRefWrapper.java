...
public class TargetEventRefWrapper {

    
    
    private TargetEventRef targetEventRef;

    public TargetEventRefWrapper(TargetEventRef targetEventRef) {
        this.targetEventRef = targetEventRef;
    }

   
    public RteEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(targetEventRef.getDest())) {
            
            return targetEventRef.getDest();
    ...
    public Object getTargetEventRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = targetEventRef.getValue();
        java.lang.String type = targetEventRef.getDest().toString().replace("_", "-");
