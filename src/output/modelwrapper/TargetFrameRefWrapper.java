...
public class TargetFrameRefWrapper {

    
    
    private TargetFrameRef targetFrameRef;

    public TargetFrameRefWrapper(TargetFrameRef targetFrameRef) {
        this.targetFrameRef = targetFrameRef;
    }

   
    public FrameTriggeringSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(targetFrameRef.getDest())) {
            
            return targetFrameRef.getDest();
    ...
    public Object getTargetFrameRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = targetFrameRef.getValue();
        java.lang.String type = targetFrameRef.getDest().toString().replace("_", "-");
