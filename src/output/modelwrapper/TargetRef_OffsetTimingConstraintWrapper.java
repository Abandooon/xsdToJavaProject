...
public class TargetRef_OffsetTimingConstraintWrapper {

    
    
    private TargetRef_OffsetTimingConstraint targetRef_OffsetTimingConstraint;

    public TargetRef_OffsetTimingConstraintWrapper(TargetRef_OffsetTimingConstraint targetRef_OffsetTimingConstraint) {
        this.targetRef_OffsetTimingConstraint = targetRef_OffsetTimingConstraint;
    }

   
    public TimingDescriptionEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(targetRef_OffsetTimingConstraint.getDest())) {
            
            return targetRef_OffsetTimingConstraint.getDest();
    ...
    public Object getTargetRef_OffsetTimingConstraintObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = targetRef_OffsetTimingConstraint.getValue();
        java.lang.String type = targetRef_OffsetTimingConstraint.getDest().toString().replace("_", "-");
