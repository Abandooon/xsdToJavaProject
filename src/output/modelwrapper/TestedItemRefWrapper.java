...
public class TestedItemRefWrapper {

    
    
    private TestedItemRef testedItemRef;

    public TestedItemRefWrapper(TestedItemRef testedItemRef) {
        this.testedItemRef = testedItemRef;
    }

   
    public TraceableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(testedItemRef.getDest())) {
            
            return testedItemRef.getDest();
    ...
    public Object getTestedItemRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = testedItemRef.getValue();
        java.lang.String type = testedItemRef.getDest().toString().replace("_", "-");
