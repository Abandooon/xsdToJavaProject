...
public class TpSduRef_CanTpConnectionWrapper {

    
    
    private TpSduRef_CanTpConnection tpSduRef_CanTpConnection;

    public TpSduRef_CanTpConnectionWrapper(TpSduRef_CanTpConnection tpSduRef_CanTpConnection) {
        this.tpSduRef_CanTpConnection = tpSduRef_CanTpConnection;
    }

   
    public IPduSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(tpSduRef_CanTpConnection.getDest())) {
            
            return tpSduRef_CanTpConnection.getDest();
    ...
    public Object getTpSduRef_CanTpConnectionObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = tpSduRef_CanTpConnection.getValue();
        java.lang.String type = tpSduRef_CanTpConnection.getDest().toString().replace("_", "-");
