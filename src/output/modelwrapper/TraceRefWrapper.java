...
public class TraceRefWrapper {

    
    
    private TraceRef traceRef;

    public TraceRefWrapper(TraceRef traceRef) {
    ...
    public TraceableSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(traceRef.getDest())) {
            
            return traceRef.getDest();
    ...
    public Object getTraceRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = traceRef.getValue();
        java.lang.String type = traceRef.getDest().toString().replace("_", "-");
