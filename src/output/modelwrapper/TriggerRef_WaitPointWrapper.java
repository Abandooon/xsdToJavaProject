...
public class TriggerRef_WaitPointWrapper {

    
    
    private TriggerRef_WaitPoint triggerRef_WaitPoint;

    public TriggerRef_WaitPointWrapper(TriggerRef_WaitPoint triggerRef_WaitPoint) {
        this.triggerRef_WaitPoint = triggerRef_WaitPoint;
    }

   
    public RteEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(triggerRef_WaitPoint.getDest())) {
            
            return triggerRef_WaitPoint.getDest();
    ...
    public Object getTriggerRef_WaitPointObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = triggerRef_WaitPoint.getValue();
        java.lang.String type = triggerRef_WaitPoint.getDest().toString().replace("_", "-");
