...
public class TriggeringEventRefWrapper {

    
    
    private TriggeringEventRef triggeringEventRef;

    public TriggeringEventRefWrapper(TriggeringEventRef triggeringEventRef) {
        this.triggeringEventRef = triggeringEventRef;
    }

   
    public TimingDescriptionEventSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(triggeringEventRef.getDest())) {
            
            return triggeringEventRef.getDest();
    ...
    public Object getTriggeringEventRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = triggeringEventRef.getValue();
        java.lang.String type = triggeringEventRef.getDest().toString().replace("_", "-");
