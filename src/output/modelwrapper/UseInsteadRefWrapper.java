...
public class UseInsteadRefWrapper {

    
    
    private UseInsteadRef useInsteadRef;

    public UseInsteadRefWrapper(UseInsteadRef useInsteadRef) {
        this.useInsteadRef = useInsteadRef;
    }

   
    public ReferrableSubtypesEnum getDest() {
        
        if (CollUtil.isNotEmpty(useInsteadRef.getDest())) {
            
            return useInsteadRef.getDest();
    ...
    public Object getUseInsteadRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = useInsteadRef.getValue();
        java.lang.String type = useInsteadRef.getDest().toString().replace("_", "-");
