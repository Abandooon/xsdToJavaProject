...
public class ValueRefWrapper {

    
    
    private ValueRef valueRef;

    public ValueRefWrapper(ValueRef valueRef) {
    ...
    public ReferrableSubtypesEnum getDest() {
        ...
        if (CollUtil.isNotEmpty(valueRef.getDest())) {
            
            return valueRef.getDest();
    ...
    public Object getValueRefObj() throws BaseXException, ClassNotFoundException, JAXBException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException {
        java.lang.String path = valueRef.getValue();
        java.lang.String type = valueRef.getDest().toString().replace("_", "-");
