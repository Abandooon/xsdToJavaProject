...
@XmlRootElement(name = "ALIAS-NAME-SET")
public class AliasNameSet {
    ...
    protected ArrayList<AliasNameAssignment> aliasNames;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="ALIAS-NAMES")
@XmlElement(name="ALIAS-NAME-ASSIGNMENT")
    public ArrayList<AliasNameAssignment> getAliasNames() {
    return this.aliasNames;
}

    public void setAliasNames(ArrayList<AliasNameAssignment> value) {
