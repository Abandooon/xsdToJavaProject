...
@XmlRootElement(name = "APPLICATION-ARRAY-DATA-TYPE")
public class ApplicationArrayDataType {
    ...
    protected ApplicationArrayElement element;
...
@XmlElement(name="ANNOTATION")
    ...
    public ApplicationArrayElement getElement() {
    return this.element;
}

    public void setElement(ApplicationArrayElement value) {
        this.element = value;
    }
