...
@XmlRootElement(name = "APPLICATION-RECORD-DATA-TYPE")
public class ApplicationRecordDataType {
    ...
    protected ArrayList<ApplicationRecordElement> elements;
...
@XmlElement(name="APPLICATION-RECORD-ELEMENT")
    public ArrayList<ApplicationRecordElement> getElements() {
    return this.elements;
}

    public void setElements(ArrayList<ApplicationRecordElement> value) {
        this.elements = value;
    }
