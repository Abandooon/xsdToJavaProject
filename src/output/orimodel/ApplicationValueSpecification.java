...
@XmlRootElement(name = "APPLICATION-VALUE-SPECIFICATION")
public class ApplicationValueSpecification {
    ...
    protected ArrayList<SwAxisCont> swAxisConts;
...
@XmlElement(name="SW-AXIS-CONT")
    public ArrayList<SwAxisCont> getSwAxisConts() {
    return this.swAxisConts;
}

    public void setSwAxisConts(ArrayList<SwAxisCont> value) {
