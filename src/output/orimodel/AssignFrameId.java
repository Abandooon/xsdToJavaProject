...
@XmlRootElement(name = "ASSIGN-FRAME-ID")
public class AssignFrameId {
    ...
    protected AssignedFrameTriggeringRef assignedFrameTriggeringRef;
    ...
    public AssignedFrameTriggeringRef getAssignedFrameTriggeringRef() {
    return this.assignedFrameTriggeringRef;
}

    public void setAssignedFrameTriggeringRef(AssignedFrameTriggeringRef value) {
