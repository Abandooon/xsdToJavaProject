...
@XmlRootElement(name = "ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT")
public class AsynchronousServerCallReturnsEvent {
    ...
    protected StartOnEventRef startOnEventRef;
    ...
    protected EventSourceRef_AsynchronousServerCallReturnsEvent eventSourceRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="DISABLED-MODE-IREFS")
@XmlElement(name="DISABLED-MODE-IREF")
    ...
    public StartOnEventRef getStartOnEventRef() {
    return this.startOnEventRef;
}

    public void setStartOnEventRef(StartOnEventRef value) {
    ...
    public EventSourceRef_AsynchronousServerCallReturnsEvent getEventSourceRef() {
    return this.eventSourceRef;
}

    public void setEventSourceRef(EventSourceRef_AsynchronousServerCallReturnsEvent value) {
