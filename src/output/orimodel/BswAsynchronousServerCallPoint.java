...
@XmlRootElement(name = "BSW-ASYNCHRONOUS-SERVER-CALL-POINT")
public class BswAsynchronousServerCallPoint {
    ...
    protected CalledEntryRef_BswSynchronousServerCallPoint calledEntryRef;
...
@XmlElement(name="CONTEXT-LIMITATION-REF")
    ...
    public CalledEntryRef_BswSynchronousServerCallPoint getCalledEntryRef() {
    return this.calledEntryRef;
}

    public void setCalledEntryRef(CalledEntryRef_BswSynchronousServerCallPoint value) {
