...
@XmlRootElement(name = "BSW-ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT")
public class BswAsynchronousServerCallReturnsEvent {
    ...
    protected EventSourceRef_BswAsynchronousServerCallReturnsEvent eventSourceRef;
...
@XmlElement(name="DISABLED-IN-MODE-IREF")
    ...
    public EventSourceRef_BswAsynchronousServerCallReturnsEvent getEventSourceRef() {
    return this.eventSourceRef;
}

    public void setEventSourceRef(EventSourceRef_BswAsynchronousServerCallReturnsEvent value) {
