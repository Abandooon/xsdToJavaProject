...
@XmlRootElement(name = "BSW-DATA-SEND-POLICY")
public class BswDataSendPolicy {
    ...
    protected ProviedeDataRef proviedeDataRef;
    ...
    public ProviedeDataRef getProviedeDataRef() {
    return this.proviedeDataRef;
}

    public void setProviedeDataRef(ProviedeDataRef value) {
