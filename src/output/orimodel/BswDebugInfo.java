...
@XmlRootElement(name = "BSW-DEBUG-INFO")
public class BswDebugInfo {
    ...
    protected ArrayList<ImplementationDataTypeElement> localDebugDatas;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="LOCAL-DEBUG-DATAS")
@XmlElement(name="IMPLEMENTATION-DATA-TYPE-ELEMENT")
    public ArrayList<ImplementationDataTypeElement> getLocalDebugDatas() {
    return this.localDebugDatas;
}

    public void setLocalDebugDatas(ArrayList<ImplementationDataTypeElement> value) {
        this.localDebugDatas = value;
    }
    
    
    
    @XmlElementWrapper(name="PARAMETER-ACCESSED-FOR-DEBUG-REFS")
@XmlElement(name="PARAMETER-ACCESSED-FOR-DEBUG-REF")
    ...
    @XmlElementWrapper(name="VARIABLE-ACCESSED-FOR-DEBUG-REFS")
