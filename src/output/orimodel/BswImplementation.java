...
@XmlRootElement(name = "BSW-IMPLEMENTATION")
public class BswImplementation {
    ...
    protected ArrayList<BswDebugInfo> debugInfos;
...
@XmlElement(name="DEPENDENCY-ON-ARTIFACT")
    ...
    @XmlElementWrapper(name="DEBUG-INFOS")
@XmlElement(name="BSW-DEBUG-INFO")
    public ArrayList<BswDebugInfo> getDebugInfos() {
    return this.debugInfos;
}

    public void setDebugInfos(ArrayList<BswDebugInfo> value) {
        this.debugInfos = value;
    }
    
    
    
    @XmlElementWrapper(name="PRECONFIGURED-CONFIGURATION-REFS")
@XmlElement(name="PRECONFIGURED-CONFIGURATION-REF")
    ...
    @XmlElementWrapper(name="RECOMMENDED-CONFIGURATION-REFS")
@XmlElement(name="RECOMMENDED-CONFIGURATION-REF")
    ...
    @XmlElementWrapper(name="VENDOR-SPECIFIC-MODULE-DEF-REFS")
