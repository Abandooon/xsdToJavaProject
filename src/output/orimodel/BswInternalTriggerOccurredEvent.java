...
@XmlRootElement(name = "BSW-INTERNAL-TRIGGER-OCCURRED-EVENT")
public class BswInternalTriggerOccurredEvent {
    ...
    protected EventSourceRef_BswInternalTriggerOccurredEvent eventSourceRef;
...
@XmlElement(name="DISABLED-IN-MODE-IREF")
    ...
    public EventSourceRef_BswInternalTriggerOccurredEvent getEventSourceRef() {
    return this.eventSourceRef;
}

    public void setEventSourceRef(EventSourceRef_BswInternalTriggerOccurredEvent value) {
