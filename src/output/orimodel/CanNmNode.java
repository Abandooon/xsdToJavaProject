...
@XmlRootElement(name = "CAN-NM-NODE")
public class CanNmNode {
    ...
    protected TimeValue nmMsgReducedTime;
    
    
    
    protected CanNmRangeConfig nmRangeConfig;
...
@XmlElement(name="TX-NM-PDU-REF")
    ...
    @XmlElement(name="NM-MSG-REDUCED-TIME")
    public TimeValue getNmMsgReducedTime() {
    return this.nmMsgReducedTime;
}

    public void setNmMsgReducedTime(TimeValue value) {
        this.nmMsgReducedTime = value;
    }
    
    
    
    @XmlElement(name="NM-RANGE-CONFIG")
    public CanNmRangeConfig getNmRangeConfig() {
    return this.nmRangeConfig;
}

    public void setNmRangeConfig(CanNmRangeConfig value) {
        this.nmRangeConfig = value;
    }
