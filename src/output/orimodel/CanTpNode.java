...
@XmlRootElement(name = "CAN-TP-NODE")
public class CanTpNode {
    ...
    protected TpAddressRef_CanTpNode tpAddressRef;
...
@XmlElement(name="ANNOTATION")
    ...
    public TpAddressRef_CanTpNode getTpAddressRef() {
    return this.tpAddressRef;
}

    public void setTpAddressRef(TpAddressRef_CanTpNode value) {
