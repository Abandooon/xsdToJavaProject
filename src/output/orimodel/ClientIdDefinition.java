...
@XmlRootElement(name = "CLIENT-ID-DEFINITION")
public class ClientIdDefinition {
    ...
    protected NumericalValue clientId;
...
@XmlElement(name="ANNOTATION")
    ...
    public NumericalValue getClientId() {
    return this.clientId;
}

    public void setClientId(NumericalValue value) {
        this.clientId = value;
    }
