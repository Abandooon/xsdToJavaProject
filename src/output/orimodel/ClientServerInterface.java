...
@XmlRootElement(name = "CLIENT-SERVER-INTERFACE")
public class ClientServerInterface {
    ...
    protected ArrayList<ClientServerOperation> operations;
    
    
    
    protected ArrayList<ApplicationError> possibleErrors;
...
@XmlElement(name="CLIENT-SERVER-OPERATION")
    public ArrayList<ClientServerOperation> getOperations() {
    return this.operations;
}

    public void setOperations(ArrayList<ClientServerOperation> value) {
        this.operations = value;
    }
    
    
    
    @XmlElementWrapper(name="POSSIBLE-ERRORS")
@XmlElement(name="APPLICATION-ERROR")
    public ArrayList<ApplicationError> getPossibleErrors() {
    return this.possibleErrors;
}

    public void setPossibleErrors(ArrayList<ApplicationError> value) {
        this.possibleErrors = value;
    }
