...
public class Code {
    ...
    protected ArrayList<AutosarEngineeringObject> artifactDescriptors;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="ARTIFACT-DESCRIPTORS")
@XmlElement(name="AUTOSAR-ENGINEERING-OBJECT")
    public ArrayList<AutosarEngineeringObject> getArtifactDescriptors() {
    return this.artifactDescriptors;
}

    public void setArtifactDescriptors(ArrayList<AutosarEngineeringObject> value) {
        this.artifactDescriptors = value;
    }
    
    
    
    @XmlElementWrapper(name="CALLBACK-HEADER-REFS")
