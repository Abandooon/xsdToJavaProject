...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="ELEMENT-REFS")
@XmlElement(name="ELEMENT-REF")
    ...
    @XmlElementWrapper(name="SOURCE-ELEMENT-REFS")
@XmlElement(name="SOURCE-ELEMENT-REF")
    ...
    @XmlElementWrapper(name="COLLECTED-INSTANCE-IREFS")
@XmlElement(name="COLLECTED-INSTANCE-IREF")
    ...
    @XmlElementWrapper(name="SOURCE-INSTANCE-IREFS")
