...
@XmlRootElement(name = "COMPOSITION-SW-COMPONENT-TYPE")
public class CompositionSwComponentType {
    ...
    protected ArrayList<SwComponentPrototype> components;
    
    
    
    protected Connectors_CompositionSwComponentType connectors;
    ...
    protected ArrayList<InstantiationTimingEventProps> instantiationRteEventPropss;
...
@XmlElement(name="SW-COMPONENT-PROTOTYPE")
    public ArrayList<SwComponentPrototype> getComponents() {
    return this.components;
}

    public void setComponents(ArrayList<SwComponentPrototype> value) {
    ...
    public Connectors_CompositionSwComponentType getConnectors() {
    return this.connectors;
}

    public void setConnectors(Connectors_CompositionSwComponentType value) {
...
@XmlElement(name="DATA-TYPE-MAPPING-REF")
    ...
    @XmlElementWrapper(name="INSTANTIATION-RTE-EVENT-PROPSS")
@XmlElement(name="INSTANTIATION-TIMING-EVENT-PROPS")
    public ArrayList<InstantiationTimingEventProps> getInstantiationRteEventPropss() {
    return this.instantiationRteEventPropss;
}

    public void setInstantiationRteEventPropss(ArrayList<InstantiationTimingEventProps> value) {
