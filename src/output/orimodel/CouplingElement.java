...
@XmlRootElement(name = "COUPLING-ELEMENT")
public class CouplingElement {
    ...
    protected CommunicationClusterRef_CouplingElement communicationClusterRef;
    ...
    protected CouplingElementEnum couplingType;
...
@XmlElement(name="ANNOTATION")
    ...
    public CommunicationClusterRef_CouplingElement getCommunicationClusterRef() {
    return this.communicationClusterRef;
}

    public void setCommunicationClusterRef(CommunicationClusterRef_CouplingElement value) {
...
@XmlElement(name="COUPLING-PORT")
    ...
    @XmlElement(name="COUPLING-TYPE")
    public CouplingElementEnum getCouplingType() {
    return this.couplingType;
}

    public void setCouplingType(CouplingElementEnum value) {
