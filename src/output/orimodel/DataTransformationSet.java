...
@XmlRootElement(name = "DATA-TRANSFORMATION-SET")
public class DataTransformationSet {
    ...
    protected ArrayList<DataTransformation> dataTransformations;
...
@XmlElement(name="DATA-TRANSFORMATION")
    public ArrayList<DataTransformation> getDataTransformations() {
    return this.dataTransformations;
}

    public void setDataTransformations(ArrayList<DataTransformation> value) {
        this.dataTransformations = value;
    }
    
    
    
    @XmlElementWrapper(name="TRANSFORMATION-TECHNOLOGYS")
