...
@XmlRootElement(name = "DCM-I-PDU")
public class DcmIPdu {
    ...
    protected DiagPduType diagPduType;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="DIAG-PDU-TYPE")
    public DiagPduType getDiagPduType() {
    return this.diagPduType;
}

    public void setDiagPduType(DiagPduType value) {
        this.diagPduType = value;
    }
