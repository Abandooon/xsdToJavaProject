...
@XmlRootElement(name = "DIAGNOSTIC-COMMON-PROPS-CONDITIONAL")
public class DiagnosticCommonPropsConditional {
    ...
    protected ArrayList<DiagnosticDebounceAlgorithmProps> debounceAlgorithmPropss;
    ...
    @XmlElementWrapper(name="DEBOUNCE-ALGORITHM-PROPSS")
@XmlElement(name="DIAGNOSTIC-DEBOUNCE-ALGORITHM-PROPS")
    public ArrayList<DiagnosticDebounceAlgorithmProps> getDebounceAlgorithmPropss() {
    return this.debounceAlgorithmPropss;
}

    public void setDebounceAlgorithmPropss(ArrayList<DiagnosticDebounceAlgorithmProps> value) {
