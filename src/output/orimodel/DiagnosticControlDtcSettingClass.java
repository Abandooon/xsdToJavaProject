...
@XmlRootElement(name = "DIAGNOSTIC-CONTROL-DTC-SETTING-CLASS")
public class DiagnosticControlDtcSettingClass {
    ...
    protected Boolean controlOptionRecordPresent;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="CONTROL-OPTION-RECORD-PRESENT")
    public Boolean getControlOptionRecordPresent() {
    return this.controlOptionRecordPresent;
}

    public void setControlOptionRecordPresent(Boolean value) {
        this.controlOptionRecordPresent = value;
    }
