...
@XmlRootElement(name = "DIAGNOSTIC-CUSTOM-SERVICE-CLASS")
public class DiagnosticCustomServiceClass {
    ...
    protected PositiveInteger customServiceId;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="CUSTOM-SERVICE-ID")
    public PositiveInteger getCustomServiceId() {
    return this.customServiceId;
}

    public void setCustomServiceId(PositiveInteger value) {
