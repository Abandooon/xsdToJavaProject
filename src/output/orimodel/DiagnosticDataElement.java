...
@XmlRootElement(name = "DIAGNOSTIC-DATA-ELEMENT")
public class DiagnosticDataElement {
    ...
    protected PositiveInteger maxNumberOfElements;
...
@XmlElement(name="ANNOTATION")
    ...
    public PositiveInteger getMaxNumberOfElements() {
    return this.maxNumberOfElements;
}

    public void setMaxNumberOfElements(PositiveInteger value) {
