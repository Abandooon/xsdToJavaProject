...
@XmlRootElement(name = "DIAGNOSTIC-ENABLE-CONDITION-NEEDS")
public class DiagnosticEnableConditionNeeds {
    ...
    protected EventAcceptanceStatusEnum initialStatus;
...
@XmlElement(name="AUDIENCE")
    ...
    public EventAcceptanceStatusEnum getInitialStatus() {
    return this.initialStatus;
}

    public void setInitialStatus(EventAcceptanceStatusEnum value) {
