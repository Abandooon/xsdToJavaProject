...
@XmlRootElement(name = "DIAGNOSTIC-ENABLE-CONDITION-PORT-MAPPING")
public class DiagnosticEnableConditionPortMapping {
    ...
    protected EnableConditionRef enableConditionRef;
...
@XmlElement(name="ANNOTATION")
    ...
    public EnableConditionRef getEnableConditionRef() {
    return this.enableConditionRef;
}

    public void setEnableConditionRef(EnableConditionRef value) {
