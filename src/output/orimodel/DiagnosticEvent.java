...
@XmlRootElement(name = "DIAGNOSTIC-EVENT")
public class DiagnosticEvent {
    ...
    protected ArrayList<DiagnosticConnectedIndicator> connectedIndicators;
...
@XmlElement(name="ANNOTATION")
    ...
    return this.clearEventBehavior;
}
    ...
    @XmlElementWrapper(name="CONNECTED-INDICATORS")
@XmlElement(name="DIAGNOSTIC-CONNECTED-INDICATOR")
    public ArrayList<DiagnosticConnectedIndicator> getConnectedIndicators() {
    return this.connectedIndicators;
}

    public void setConnectedIndicators(ArrayList<DiagnosticConnectedIndicator> value) {
    ...
    return this.eventFailureCycleCounterThreshold;
}
    ...
    return this.prestorageFreezeFrame;
}
