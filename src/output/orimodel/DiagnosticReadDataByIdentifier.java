...
@XmlRootElement(name = "DIAGNOSTIC-READ-DATA-BY-IDENTIFIER")
public class DiagnosticReadDataByIdentifier {
    ...
    protected ReadClassRef_DiagnosticReadDataByIdentifier readClassRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="READ-CLASS-REF")
    public ReadClassRef_DiagnosticReadDataByIdentifier getReadClassRef() {
    return this.readClassRef;
}

    public void setReadClassRef(ReadClassRef_DiagnosticReadDataByIdentifier value) {
        this.readClassRef = value;
    }
