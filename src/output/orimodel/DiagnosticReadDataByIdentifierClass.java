...
@XmlRootElement(name = "DIAGNOSTIC-READ-DATA-BY-IDENTIFIER-CLASS")
public class DiagnosticReadDataByIdentifierClass {
    ...
    protected PositiveInteger maxDidToRead;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="MAX-DID-TO-READ")
    public PositiveInteger getMaxDidToRead() {
    return this.maxDidToRead;
}

    public void setMaxDidToRead(PositiveInteger value) {
        this.maxDidToRead = value;
    }
