...
@XmlRootElement(name = "DIAGNOSTIC-READ-DATA-BY-PERIODIC-ID")
public class DiagnosticReadDataByPeriodicId {
    ...
    protected ReadDataClassRef readDataClassRef;
...
@XmlElement(name="ANNOTATION")
    ...
    public ReadDataClassRef getReadDataClassRef() {
    return this.readDataClassRef;
}

    public void setReadDataClassRef(ReadDataClassRef value) {
