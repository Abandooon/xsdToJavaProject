...
@XmlRootElement(name = "DIAGNOSTIC-RESPONSE-ON-EVENT-CLASS")
public class DiagnosticResponseOnEventClass {
    ...
    protected TimeValue interMessageTime;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="INTER-MESSAGE-TIME")
    public TimeValue getInterMessageTime() {
    return this.interMessageTime;
}

    public void setInterMessageTime(TimeValue value) {
