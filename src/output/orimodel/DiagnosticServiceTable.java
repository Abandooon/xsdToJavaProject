...
@XmlRootElement(name = "DIAGNOSTIC-SERVICE-TABLE")
public class DiagnosticServiceTable {
    ...
    protected ArrayList<DiagnosticConnectionRefConditional> diagnosticConnections;
    ...
    protected ArrayList<ServiceInstanceRef_DiagnosticServiceTable> serviceInstanceRefs;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="DIAGNOSTIC-CONNECTIONS")
@XmlElement(name="DIAGNOSTIC-CONNECTION-REF-CONDITIONAL")
    public ArrayList<DiagnosticConnectionRefConditional> getDiagnosticConnections() {
    return this.diagnosticConnections;
}

    public void setDiagnosticConnections(ArrayList<DiagnosticConnectionRefConditional> value) {
...
@XmlElement(name="SERVICE-INSTANCE-REF")
    public ArrayList<ServiceInstanceRef_DiagnosticServiceTable> getServiceInstanceRefs() {
    return this.serviceInstanceRefs;
}

    public void setServiceInstanceRefs(ArrayList<ServiceInstanceRef_DiagnosticServiceTable> value) {
