...
@XmlRootElement(name = "DIAGNOSTIC-WRITE-MEMORY-BY-ADDRESS")
public class DiagnosticWriteMemoryByAddress {
    ...
    protected WriteClassRef_DiagnosticWriteMemoryByAddress writeClassRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="MEMORY-RANGE-REFS")
@XmlElement(name="MEMORY-RANGE-REF")
    ...
    @XmlElement(name="WRITE-CLASS-REF")
    public WriteClassRef_DiagnosticWriteMemoryByAddress getWriteClassRef() {
    return this.writeClassRef;
}

    public void setWriteClassRef(WriteClassRef_DiagnosticWriteMemoryByAddress value) {
        this.writeClassRef = value;
    }
