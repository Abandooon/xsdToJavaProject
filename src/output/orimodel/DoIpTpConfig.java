...
@XmlRootElement(name = "DO-IP-TP-CONFIG")
public class DoIpTpConfig {
    ...
    protected ArrayList<DoIpTpConnection> tpConnections;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="DO-IP-LOGIC-ADDRESSS")
...
@XmlElement(name="DO-IP-TP-CONNECTION")
    public ArrayList<DoIpTpConnection> getTpConnections() {
    return this.tpConnections;
}

    public void setTpConnections(ArrayList<DoIpTpConnection> value) {
