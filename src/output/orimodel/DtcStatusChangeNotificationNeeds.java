...
@XmlRootElement(name = "DTC-STATUS-CHANGE-NOTIFICATION-NEEDS")
public class DtcStatusChangeNotificationNeeds {
    ...
    protected DtcFormatTypeEnum dtcFormatType;
...
@XmlElement(name="AUDIENCE")
    ...
    @XmlElement(name="DTC-FORMAT-TYPE")
    public DtcFormatTypeEnum getDtcFormatType() {
    return this.dtcFormatType;
}

    public void setDtcFormatType(DtcFormatTypeEnum value) {
        this.dtcFormatType = value;
    }
