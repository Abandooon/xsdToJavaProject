...
@XmlRootElement(name = "ECUC-BOOLEAN-PARAM-DEF")
public class EcucBooleanParamDef {
    ...
    protected BooleanValueVariationPoint defaultValue;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    public BooleanValueVariationPoint getDefaultValue() {
    return this.defaultValue;
}

    public void setDefaultValue(BooleanValueVariationPoint value) {
