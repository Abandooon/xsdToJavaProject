...
@XmlRootElement(name = "ECUC-DESTINATION-URI-DEF-SET")
public class EcucDestinationUriDefSet {
    ...
    protected ArrayList<EcucDestinationUriDef> destinationUriDefs;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="DESTINATION-URI-DEFS")
@XmlElement(name="ECUC-DESTINATION-URI-DEF")
    public ArrayList<EcucDestinationUriDef> getDestinationUriDefs() {
    return this.destinationUriDefs;
}

    public void setDestinationUriDefs(ArrayList<EcucDestinationUriDef> value) {
        this.destinationUriDefs = value;
    }
