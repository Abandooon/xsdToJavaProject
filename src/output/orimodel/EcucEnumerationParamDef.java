...
@XmlRootElement(name = "ECUC-ENUMERATION-PARAM-DEF")
public class EcucEnumerationParamDef {
    ...
    protected ArrayList<EcucEnumerationLiteralDef> literals;
...
@XmlElement(name="ECUC-ENUMERATION-LITERAL-DEF")
    public ArrayList<EcucEnumerationLiteralDef> getLiterals() {
    return this.literals;
}

    public void setLiterals(ArrayList<EcucEnumerationLiteralDef> value) {
        this.literals = value;
    }
