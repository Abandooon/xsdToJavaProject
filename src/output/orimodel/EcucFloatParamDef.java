...
@XmlRootElement(name = "ECUC-FLOAT-PARAM-DEF")
public class EcucFloatParamDef {
    ...
    protected FloatValueVariationPoint defaultValue;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    public FloatValueVariationPoint getDefaultValue() {
    return this.defaultValue;
}

    public void setDefaultValue(FloatValueVariationPoint value) {
    ...
    public void setMax(Limit value) {
        this.max = value;
    }
    ...
    public void setMin(Limit value) {
        this.min = value;
    }
