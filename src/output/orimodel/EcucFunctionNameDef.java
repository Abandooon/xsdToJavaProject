...
@XmlRootElement(name = "ECUC-FUNCTION-NAME-DEF")
public class EcucFunctionNameDef {
    ...
    protected ArrayList<EcucFunctionNameDefConditional> ecucFunctionNameDefVariants;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    @XmlElementWrapper(name="ECUC-FUNCTION-NAME-DEF-VARIANTS")
@XmlElement(name="ECUC-FUNCTION-NAME-DEF-CONDITIONAL")
    public ArrayList<EcucFunctionNameDefConditional> getEcucFunctionNameDefVariants() {
    return this.ecucFunctionNameDefVariants;
}

    public void setEcucFunctionNameDefVariants(ArrayList<EcucFunctionNameDefConditional> value) {
