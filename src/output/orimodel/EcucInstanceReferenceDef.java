...
@XmlRootElement(name = "ECUC-INSTANCE-REFERENCE-DEF")
public class EcucInstanceReferenceDef {
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    @XmlElement(name="DESTINATION-CONTEXT")
    public String getDestinationContext() {
    return this.destinationContext;
}

    public void setDestinationContext(String value) {
        this.destinationContext = value;
    }
    
    
    
    @XmlElement(name="DESTINATION-TYPE")
