...
@XmlRootElement(name = "ECUC-INTEGER-PARAM-DEF")
public class EcucIntegerParamDef {
    ...
    protected UnlimitedIntegerValueVariationPoint defaultValue;
    
    
    
    protected UnlimitedIntegerValueVariationPoint max;
    
    
    
    protected UnlimitedIntegerValueVariationPoint min;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    public UnlimitedIntegerValueVariationPoint getDefaultValue() {
    return this.defaultValue;
}

    public void setDefaultValue(UnlimitedIntegerValueVariationPoint value) {
    ...
    @XmlElement(name="MAX")
    public UnlimitedIntegerValueVariationPoint getMax() {
    return this.max;
}

    public void setMax(UnlimitedIntegerValueVariationPoint value) {
        this.max = value;
    }
    ...
    @XmlElement(name="MIN")
    public UnlimitedIntegerValueVariationPoint getMin() {
    return this.min;
}

    public void setMin(UnlimitedIntegerValueVariationPoint value) {
        this.min = value;
    }
