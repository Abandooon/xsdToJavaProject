...
@XmlRootElement(name = "ECUC-LINKER-SYMBOL-DEF")
public class EcucLinkerSymbolDef {
    ...
    protected ArrayList<EcucLinkerSymbolDefConditional> ecucLinkerSymbolDefVariants;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    @XmlElementWrapper(name="ECUC-LINKER-SYMBOL-DEF-VARIANTS")
@XmlElement(name="ECUC-LINKER-SYMBOL-DEF-CONDITIONAL")
    public ArrayList<EcucLinkerSymbolDefConditional> getEcucLinkerSymbolDefVariants() {
    return this.ecucLinkerSymbolDefVariants;
}

    public void setEcucLinkerSymbolDefVariants(ArrayList<EcucLinkerSymbolDefConditional> value) {
        this.ecucLinkerSymbolDefVariants = value;
    }
