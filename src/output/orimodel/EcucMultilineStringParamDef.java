...
@XmlRootElement(name = "ECUC-MULTILINE-STRING-PARAM-DEF")
public class EcucMultilineStringParamDef {
    ...
    protected ArrayList<EcucMultilineStringParamDefConditional> ecucMultilineStringParamDefVariants;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    @XmlElementWrapper(name="ECUC-MULTILINE-STRING-PARAM-DEF-VARIANTS")
@XmlElement(name="ECUC-MULTILINE-STRING-PARAM-DEF-CONDITIONAL")
    public ArrayList<EcucMultilineStringParamDefConditional> getEcucMultilineStringParamDefVariants() {
    return this.ecucMultilineStringParamDefVariants;
}

    public void setEcucMultilineStringParamDefVariants(ArrayList<EcucMultilineStringParamDefConditional> value) {
        this.ecucMultilineStringParamDefVariants = value;
    }
