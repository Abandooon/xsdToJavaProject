...
@XmlRootElement(name = "ECUC-STRING-PARAM-DEF")
public class EcucStringParamDef {
    ...
    protected ArrayList<EcucStringParamDefConditional> ecucStringParamDefVariants;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    @XmlElementWrapper(name="ECUC-STRING-PARAM-DEF-VARIANTS")
@XmlElement(name="ECUC-STRING-PARAM-DEF-CONDITIONAL")
    public ArrayList<EcucStringParamDefConditional> getEcucStringParamDefVariants() {
    return this.ecucStringParamDefVariants;
}

    public void setEcucStringParamDefVariants(ArrayList<EcucStringParamDefConditional> value) {
