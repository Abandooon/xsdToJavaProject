...
@XmlRootElement(name = "ECUC-SYMBOLIC-NAME-REFERENCE-DEF")
public class EcucSymbolicNameReferenceDef {
    ...
    protected DestinationRef_EcucSymbolicNameReferenceDef destinationRef;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    public DestinationRef_EcucSymbolicNameReferenceDef getDestinationRef() {
    return this.destinationRef;
}

    public void setDestinationRef(DestinationRef_EcucSymbolicNameReferenceDef value) {
