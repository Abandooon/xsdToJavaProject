...
@XmlRootElement(name = "ECUC-URI-REFERENCE-DEF")
public class EcucUriReferenceDef {
    ...
    protected DestinationUriRef destinationUriRef;
...
@XmlElement(name="ECUC-VALUE-CONFIGURATION-CLASS")
    ...
    public DestinationUriRef getDestinationUriRef() {
    return this.destinationUriRef;
}

    public void setDestinationUriRef(DestinationUriRef value) {
        this.destinationUriRef = value;
    }
