...
@XmlRootElement(name = "ECUC-VALIDATION-CONDITION")
public class EcucValidationCondition {
    ...
    protected EcucConditionFormula validationFormula;
...
@XmlElement(name="ECUC-QUERY")
    ...
    @XmlElement(name="VALIDATION-FORMULA")
    public EcucConditionFormula getValidationFormula() {
    return this.validationFormula;
}

    public void setValidationFormula(EcucConditionFormula value) {
