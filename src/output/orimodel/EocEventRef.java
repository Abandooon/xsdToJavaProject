...
@XmlRootElement(name = "EOC-EVENT-REF")
public class EocEventRef {
    ...
    protected EventRef_EocEventRef eventRef;
...
@XmlElement(name="DIRECT-SUCCESSOR-REF")
    ...
    public EventRef_EocEventRef getEventRef() {
    return this.eventRef;
}

    public void setEventRef(EventRef_EocEventRef value) {
        this.eventRef = value;
    }
