...
@XmlRootElement(name = "EOC-EXECUTABLE-ENTITY-REF")
public class EocExecutableEntityRef {
    ...
    protected ExecutableRef executableRef;
...
@XmlElement(name="DIRECT-SUCCESSOR-REF")
    ...
    public ExecutableRef getExecutableRef() {
    return this.executableRef;
}

    public void setExecutableRef(ExecutableRef value) {
