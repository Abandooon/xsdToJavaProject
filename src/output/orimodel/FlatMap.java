...
public class FlatMap {
    ...
    protected ArrayList<FlatInstanceDescriptor> instances;
...
@XmlElement(name="FLAT-INSTANCE-DESCRIPTOR")
    public ArrayList<FlatInstanceDescriptor> getInstances() {
    return this.instances;
}

    public void setInstances(ArrayList<FlatInstanceDescriptor> value) {
