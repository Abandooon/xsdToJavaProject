...
@XmlRootElement(name = "FLEXRAY-AR-TP-CHANNEL")
public class FlexrayArTpChannel {
    ...
    protected ArrayList<NPdu> pduPools;
    ...
    protected ArrayList<FlexrayArTpConnection> tpConnections;
    ...
    @XmlElementWrapper(name="N-PDU-REFS")
...
@XmlElement(name="N-PDU")
    public ArrayList<NPdu> getPduPools() {
    return this.pduPools;
}

    public void setPduPools(ArrayList<NPdu> value) {
        this.pduPools = value;
    }
...
@XmlElement(name="FLEXRAY-AR-TP-CONNECTION")
    public ArrayList<FlexrayArTpConnection> getTpConnections() {
    return this.tpConnections;
}

    public void setTpConnections(ArrayList<FlexrayArTpConnection> value) {
