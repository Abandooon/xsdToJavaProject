...
@XmlRootElement(name = "FLEXRAY-AR-TP-CONFIG")
public class FlexrayArTpConfig {
    ...
    protected ArrayList<FlexrayArTpChannel> tpChannels;
    
    
    
    protected ArrayList<FlexrayArTpNode> tpNodes;
...
@XmlElement(name="FLEXRAY-AR-TP-CHANNEL")
    public ArrayList<FlexrayArTpChannel> getTpChannels() {
    return this.tpChannels;
}

    public void setTpChannels(ArrayList<FlexrayArTpChannel> value) {
...
@XmlElement(name="FLEXRAY-AR-TP-NODE")
    public ArrayList<FlexrayArTpNode> getTpNodes() {
    return this.tpNodes;
}

    public void setTpNodes(ArrayList<FlexrayArTpNode> value) {
        this.tpNodes = value;
    }
