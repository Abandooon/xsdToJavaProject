...
@XmlRootElement(name = "FLEXRAY-COMMUNICATION-CONNECTOR")
public class FlexrayCommunicationConnector {
    ...
    protected Float nmReadySleepTime;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="NM-READY-SLEEP-TIME")
    public Float getNmReadySleepTime() {
    return this.nmReadySleepTime;
}

    public void setNmReadySleepTime(Float value) {
        this.nmReadySleepTime = value;
    }
    ...
    public Boolean getWakeUpChannel() {
    return this.wakeUpChannel;
}

    public void setWakeUpChannel(Boolean value) {
        this.wakeUpChannel = value;
    }
