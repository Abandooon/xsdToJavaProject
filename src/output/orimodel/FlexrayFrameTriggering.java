...
@XmlRootElement(name = "FLEXRAY-FRAME-TRIGGERING")
public class FlexrayFrameTriggering {
    ...
    protected ArrayList<FlexrayAbsolutelyScheduledTiming> absolutelyScheduledTimings;
...
@XmlElement(name="FLEXRAY-ABSOLUTELY-SCHEDULED-TIMING")
    public ArrayList<FlexrayAbsolutelyScheduledTiming> getAbsolutelyScheduledTimings() {
    return this.absolutelyScheduledTimings;
}

    public void setAbsolutelyScheduledTimings(ArrayList<FlexrayAbsolutelyScheduledTiming> value) {
    ...
    return this.allowDynamicLSduLength;
}
    ...
    return this.payloadPreambleIndicator;
}
