...
@XmlRootElement(name = "FLEXRAY-PHYSICAL-CHANNEL")
public class FlexrayPhysicalChannel {
    ...
    protected FlexrayChannelName channelName;
...
@XmlElement(name="PDU-TRIGGERING")
    ...
    public FlexrayChannelName getChannelName() {
    return this.channelName;
}

    public void setChannelName(FlexrayChannelName value) {
