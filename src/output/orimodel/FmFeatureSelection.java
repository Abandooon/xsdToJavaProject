...
@XmlRootElement(name = "FM-FEATURE-SELECTION")
public class FmFeatureSelection {
    ...
    protected ArrayList<FmAttributeValue> attributeValues;
...
@XmlElement(name="FM-ATTRIBUTE-VALUE")
    public ArrayList<FmAttributeValue> getAttributeValues() {
    return this.attributeValues;
}

    public void setAttributeValues(ArrayList<FmAttributeValue> value) {
