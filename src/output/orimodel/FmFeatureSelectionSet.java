...
@XmlRootElement(name = "FM-FEATURE-SELECTION-SET")
public class FmFeatureSelectionSet {
    ...
    protected ArrayList<FmFeatureSelection> selections;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="FEATURE-MODEL-REFS")
@XmlElement(name="FEATURE-MODEL-REF")
    ...
    @XmlElementWrapper(name="INCLUDE-REFS")
...
@XmlElement(name="FM-FEATURE-SELECTION")
    public ArrayList<FmFeatureSelection> getSelections() {
    return this.selections;
}

    public void setSelections(ArrayList<FmFeatureSelection> value) {
