...
@XmlRootElement(name = "GLOBAL-TIME-CAN-MASTER")
...
@XmlElement(name="ANNOTATION")
    ...
    return this.isSystemWideGlobalTimeMaster;
}
    ...
    return this.syncConfirmationTimeout;
}
