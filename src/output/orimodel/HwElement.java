...
@XmlRootElement(name = "HW-ELEMENT")
public class HwElement {
    ...
    protected ArrayList<HwElementRefConditional> nestedElements;
    ...
    protected ArrayList<HwElementConnector> hwElementConnections;
...
@XmlElement(name="HW-ATTRIBUTE-VALUE")
    ...
    @XmlElementWrapper(name="NESTED-ELEMENTS")
@XmlElement(name="HW-ELEMENT-REF-CONDITIONAL")
    public ArrayList<HwElementRefConditional> getNestedElements() {
    return this.nestedElements;
}

    public void setNestedElements(ArrayList<HwElementRefConditional> value) {
        this.nestedElements = value;
    }
    
    
    
    @XmlElementWrapper(name="HW-PIN-GROUPS")
@XmlElement(name="HW-PIN-GROUP")
    ...
    @XmlElementWrapper(name="HW-ELEMENT-CONNECTIONS")
@XmlElement(name="HW-ELEMENT-CONNECTOR")
    public ArrayList<HwElementConnector> getHwElementConnections() {
    return this.hwElementConnections;
}

    public void setHwElementConnections(ArrayList<HwElementConnector> value) {
