...
@XmlRootElement(name = "I-SIGNAL-I-PDU-GROUP")
public class ISignalIPduGroup {
    ...
    protected ArrayList<ISignalIPduRefConditional> iSignalIPdus;
    
    
    
    protected ArrayList<NmPduRefConditional> nmPdus;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="CONTAINED-I-SIGNAL-I-PDU-GROUP-REFS")
@XmlElement(name="CONTAINED-I-SIGNAL-I-PDU-GROUP-REF")
    ...
    @XmlElementWrapper(name="I-SIGNAL-I-PDUS")
@XmlElement(name="I-SIGNAL-I-PDU-REF-CONDITIONAL")
    public ArrayList<ISignalIPduRefConditional> getISignalIPdus() {
    return this.iSignalIPdus;
}

    public void setISignalIPdus(ArrayList<ISignalIPduRefConditional> value) {
        this.iSignalIPdus = value;
    }
    
    
    
    @XmlElementWrapper(name="NM-PDUS")
@XmlElement(name="NM-PDU-REF-CONDITIONAL")
    public ArrayList<NmPduRefConditional> getNmPdus() {
    return this.nmPdus;
}

    public void setNmPdus(ArrayList<NmPduRefConditional> value) {
        this.nmPdus = value;
    }
