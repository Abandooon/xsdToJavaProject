...
@XmlRootElement(name = "IMPLEMENTATION-DATA-TYPE")
public class ImplementationDataType {
    ...
    protected ArrayList<ImplementationDataTypeElement> subElements;
...
@XmlElement(name="ANNOTATION")
    ...
    return this.dynamicArraySizeProfile;
}
...
@XmlElement(name="IMPLEMENTATION-DATA-TYPE-ELEMENT")
    public ArrayList<ImplementationDataTypeElement> getSubElements() {
    return this.subElements;
}

    public void setSubElements(ArrayList<ImplementationDataTypeElement> value) {
