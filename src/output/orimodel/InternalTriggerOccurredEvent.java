...
@XmlRootElement(name = "INTERNAL-TRIGGER-OCCURRED-EVENT")
public class InternalTriggerOccurredEvent {
    ...
    protected EventSourceRef_InternalTriggerOccurredEvent eventSourceRef;
...
@XmlElement(name="DISABLED-MODE-IREF")
    ...
    public EventSourceRef_InternalTriggerOccurredEvent getEventSourceRef() {
    return this.eventSourceRef;
}

    public void setEventSourceRef(EventSourceRef_InternalTriggerOccurredEvent value) {
