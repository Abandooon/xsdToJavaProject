...
@XmlRootElement(name = "IPV-4-DHCP-SERVER-CONFIGURATION")
public class Ipv4DhcpServerConfiguration {
    ...
    protected ArrayList<Ip4AddressString> dnsServerAddresses;
...
@XmlElement(name="DNS-SERVER-ADDRESS")
    public ArrayList<Ip4AddressString> getDnsServerAddresses() {
    return this.dnsServerAddresses;
}

    public void setDnsServerAddresses(ArrayList<Ip4AddressString> value) {
