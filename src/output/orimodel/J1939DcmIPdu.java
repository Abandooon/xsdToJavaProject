...
@XmlRootElement(name = "J-1939-DCM-I-PDU")
public class J1939DcmIPdu {
    ...
    protected PositiveInteger diagnosticMessageType;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="DIAGNOSTIC-MESSAGE-TYPE")
    public PositiveInteger getDiagnosticMessageType() {
    return this.diagnosticMessageType;
}

    public void setDiagnosticMessageType(PositiveInteger value) {
        this.diagnosticMessageType = value;
    }
