...
@XmlRootElement(name = "J-1939-NM-CLUSTER")
public class J1939NmCluster {
    ...
    protected Boolean addressClaimEnabled;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="ADDRESS-CLAIM-ENABLED")
    public Boolean getAddressClaimEnabled() {
    return this.addressClaimEnabled;
}

    public void setAddressClaimEnabled(Boolean value) {
        this.addressClaimEnabled = value;
    }
