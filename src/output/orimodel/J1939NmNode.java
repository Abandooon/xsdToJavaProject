...
@XmlRootElement(name = "J-1939-NM-NODE")
public class J1939NmNode {
    ...
    protected J1939NodeName nodeName;
...
@XmlElement(name="TX-NM-PDU-REF")
    ...
    public J1939NodeName getNodeName() {
    return this.nodeName;
}

    public void setNodeName(J1939NodeName value) {
        this.nodeName = value;
    }
