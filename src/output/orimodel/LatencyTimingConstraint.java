...
@XmlRootElement(name = "LATENCY-TIMING-CONSTRAINT")
public class LatencyTimingConstraint {
    ...
    protected ScopeRef_LatencyTimingConstraint scopeRef;
...
@XmlElement(name="TRACE-REF")
    ...
    return this.latencyConstraintType;
}
    ...
    public ScopeRef_LatencyTimingConstraint getScopeRef() {
    return this.scopeRef;
}

    public void setScopeRef(ScopeRef_LatencyTimingConstraint value) {
        this.scopeRef = value;
    }
