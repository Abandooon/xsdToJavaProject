...
@XmlRootElement(name = "LIFE-CYCLE-STATE-DEFINITION-GROUP")
public class LifeCycleStateDefinitionGroup {
    ...
    protected ArrayList<LifeCycleState> lcStates;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="LC-STATES")
@XmlElement(name="LIFE-CYCLE-STATE")
    public ArrayList<LifeCycleState> getLcStates() {
    return this.lcStates;
}

    public void setLcStates(ArrayList<LifeCycleState> value) {
        this.lcStates = value;
    }
