...
@XmlRootElement(name = "LIN-PHYSICAL-CHANNEL")
public class LinPhysicalChannel {
    ...
    protected ArrayList<LinScheduleTable> scheduleTables;
...
@XmlElement(name="PDU-TRIGGERING")
    ...
    @XmlElementWrapper(name="SCHEDULE-TABLES")
@XmlElement(name="LIN-SCHEDULE-TABLE")
    public ArrayList<LinScheduleTable> getScheduleTables() {
    return this.scheduleTables;
}

    public void setScheduleTables(ArrayList<LinScheduleTable> value) {
