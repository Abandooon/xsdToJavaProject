...
@XmlRootElement(name = "LIN-SCHEDULE-TABLE")
public class LinScheduleTable {
    ...
    protected TableEntrys tableEntrys;
...
@XmlElement(name="ANNOTATION")
    ...
    public TableEntrys getTableEntrys() {
    return this.tableEntrys;
}

    public void setTableEntrys(TableEntrys value) {
