...
@XmlRootElement(name = "LIN-TP-CONFIG")
public class LinTpConfig {
    ...
    protected ArrayList<LinTpConnection> tpConnections;
    
    
    
    protected ArrayList<LinTpNode> tpNodes;
...
@XmlElement(name="LIN-TP-CONNECTION")
    public ArrayList<LinTpConnection> getTpConnections() {
    return this.tpConnections;
}

    public void setTpConnections(ArrayList<LinTpConnection> value) {
...
@XmlElement(name="LIN-TP-NODE")
    public ArrayList<LinTpNode> getTpNodes() {
    return this.tpNodes;
}

    public void setTpNodes(ArrayList<LinTpNode> value) {
        this.tpNodes = value;
    }
