...
@XmlRootElement(name = "LIN-TP-NODE")
public class LinTpNode {
    ...
    protected ConnectorRef_CanTpNode connectorRef;
...
@XmlElement(name="ANNOTATION")
    ...
    public ConnectorRef_CanTpNode getConnectorRef() {
    return this.connectorRef;
}

    public void setConnectorRef(ConnectorRef_CanTpNode value) {
    ...
    return this.maxNumberOfRespPendingFrames;
}
