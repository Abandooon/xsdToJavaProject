...
@XmlRootElement(name = "MODE-DECLARATION-GROUP-PROTOTYPE")
public class ModeDeclarationGroupPrototype {
    ...
    protected TypeTref_ModeDeclarationGroupPrototype typeTref;
...
@XmlElement(name="ANNOTATION")
    ...
    public TypeTref_ModeDeclarationGroupPrototype getTypeTref() {
    return this.typeTref;
}

    public void setTypeTref(TypeTref_ModeDeclarationGroupPrototype value) {
        this.typeTref = value;
    }
