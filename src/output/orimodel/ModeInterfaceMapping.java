...
@XmlRootElement(name = "MODE-INTERFACE-MAPPING")
public class ModeInterfaceMapping {
    ...
    protected ModeDeclarationGroupPrototypeMapping modeMapping;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="MODE-MAPPING")
    public ModeDeclarationGroupPrototypeMapping getModeMapping() {
    return this.modeMapping;
}

    public void setModeMapping(ModeDeclarationGroupPrototypeMapping value) {
        this.modeMapping = value;
    }
