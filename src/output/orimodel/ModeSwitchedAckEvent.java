...
@XmlRootElement(name = "MODE-SWITCHED-ACK-EVENT")
public class ModeSwitchedAckEvent {
    ...
    protected EventSourceRef_ModeSwitchedAckEvent eventSourceRef;
...
@XmlElement(name="DISABLED-MODE-IREF")
    ...
    public EventSourceRef_ModeSwitchedAckEvent getEventSourceRef() {
    return this.eventSourceRef;
}

    public void setEventSourceRef(EventSourceRef_ModeSwitchedAckEvent value) {
