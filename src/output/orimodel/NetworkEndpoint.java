...
@XmlRootElement(name = "NETWORK-ENDPOINT")
public class NetworkEndpoint {
    ...
    protected NetworkEndpointAddresses networkEndpointAddresses;
...
@XmlElement(name="ANNOTATION")
    ...
    public NetworkEndpointAddresses getNetworkEndpointAddresses() {
    return this.networkEndpointAddresses;
}

    public void setNetworkEndpointAddresses(NetworkEndpointAddresses value) {
