...
@XmlRootElement(name = "NV-DATA-INTERFACE")
public class NvDataInterface {
    ...
    protected ArrayList<VariableDataPrototype> nvDatas;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="NV-DATAS")
@XmlElement(name="VARIABLE-DATA-PROTOTYPE")
    public ArrayList<VariableDataPrototype> getNvDatas() {
    return this.nvDatas;
}

    public void setNvDatas(ArrayList<VariableDataPrototype> value) {
        this.nvDatas = value;
    }
