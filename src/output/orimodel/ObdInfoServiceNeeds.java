...
@XmlRootElement(name = "OBD-INFO-SERVICE-NEEDS")
public class ObdInfoServiceNeeds {
    ...
    protected PositiveInteger infoType;
...
@XmlElement(name="AUDIENCE")
    ...
    @XmlElement(name="INFO-TYPE")
    public PositiveInteger getInfoType() {
    return this.infoType;
}

    public void setInfoType(PositiveInteger value) {
        this.infoType = value;
    }
