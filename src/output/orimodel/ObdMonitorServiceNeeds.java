...
@XmlRootElement(name = "OBD-MONITOR-SERVICE-NEEDS")
public class ObdMonitorServiceNeeds {
    ...
    protected PositiveInteger onBoardMonitorId;
    ...
    protected PositiveInteger unitAndScalingId;
...
@XmlElement(name="AUDIENCE")
    ...
    @XmlElement(name="ON-BOARD-MONITOR-ID")
    public PositiveInteger getOnBoardMonitorId() {
    return this.onBoardMonitorId;
}

    public void setOnBoardMonitorId(PositiveInteger value) {
        this.onBoardMonitorId = value;
    }
    ...
    @XmlElement(name="UNIT-AND-SCALING-ID")
    public PositiveInteger getUnitAndScalingId() {
    return this.unitAndScalingId;
}

    public void setUnitAndScalingId(PositiveInteger value) {
        this.unitAndScalingId = value;
    }
