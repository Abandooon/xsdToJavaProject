...
@XmlRootElement(name = "OBD-PID-SERVICE-NEEDS")
public class ObdPidServiceNeeds {
    ...
    protected PositiveInteger parameterId;
...
@XmlElement(name="AUDIENCE")
    ...
    public PositiveInteger getParameterId() {
    return this.parameterId;
}

    public void setParameterId(PositiveInteger value) {
