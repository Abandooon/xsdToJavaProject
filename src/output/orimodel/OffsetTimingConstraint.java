...
@XmlRootElement(name = "OFFSET-TIMING-CONSTRAINT")
public class OffsetTimingConstraint {
    ...
    protected SourceRef_OffsetTimingConstraint sourceRef;
    
    
    
    protected TargetRef_OffsetTimingConstraint targetRef;
...
@XmlElement(name="TRACE-REF")
    ...
    public SourceRef_OffsetTimingConstraint getSourceRef() {
    return this.sourceRef;
}

    public void setSourceRef(SourceRef_OffsetTimingConstraint value) {
    ...
    public TargetRef_OffsetTimingConstraint getTargetRef() {
    return this.targetRef;
}

    public void setTargetRef(TargetRef_OffsetTimingConstraint value) {
