...
@XmlRootElement(name = "P-PORT-PROTOTYPE")
public class PPortPrototype {
    ...
    protected ProvidedInterfaceTref providedInterfaceTref;
...
@XmlElement(name="TRIGGER-PORT-ANNOTATION")
    ...
    @XmlElement(name="PROVIDED-INTERFACE-TREF")
    public ProvidedInterfaceTref getProvidedInterfaceTref() {
    return this.providedInterfaceTref;
}

    public void setProvidedInterfaceTref(ProvidedInterfaceTref value) {
        this.providedInterfaceTref = value;
    }
