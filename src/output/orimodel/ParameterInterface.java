...
@XmlRootElement(name = "PARAMETER-INTERFACE")
public class ParameterInterface {
    ...
    protected ArrayList<ParameterDataPrototype> parameters;
...
@XmlElement(name="PARAMETER-DATA-PROTOTYPE")
    public ArrayList<ParameterDataPrototype> getParameters() {
    return this.parameters;
}

    public void setParameters(ArrayList<ParameterDataPrototype> value) {
