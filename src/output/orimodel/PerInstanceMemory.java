...
@XmlRootElement(name = "PER-INSTANCE-MEMORY")
public class PerInstanceMemory {
...
@XmlElement(name="ANNOTATION")
    ...
    public CIdentifier getType() {
    return this.type;
}

    public void setType(CIdentifier value) {
        this.type = value;
    }
