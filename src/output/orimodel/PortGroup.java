...
@XmlRootElement(name = "PORT-GROUP")
public class PortGroup {
    ...
    protected ArrayList<PortPrototypeRefConditional> outerPorts;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="INNER-GROUP-IREFS")
@XmlElement(name="INNER-GROUP-IREF")
    ...
    @XmlElementWrapper(name="OUTER-PORTS")
@XmlElement(name="PORT-PROTOTYPE-REF-CONDITIONAL")
    public ArrayList<PortPrototypeRefConditional> getOuterPorts() {
    return this.outerPorts;
}

    public void setOuterPorts(ArrayList<PortPrototypeRefConditional> value) {
