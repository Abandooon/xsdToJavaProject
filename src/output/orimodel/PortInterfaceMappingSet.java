...
@XmlRootElement(name = "PORT-INTERFACE-MAPPING-SET")
public class PortInterfaceMappingSet {
    ...
    protected PortInterfaceMappings portInterfaceMappings;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="PORT-INTERFACE-MAPPINGS")
    public PortInterfaceMappings getPortInterfaceMappings() {
    return this.portInterfaceMappings;
}

    public void setPortInterfaceMappings(PortInterfaceMappings value) {
        this.portInterfaceMappings = value;
    }
