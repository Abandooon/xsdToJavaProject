...
@XmlRootElement(name = "SENDER-RECEIVER-INTERFACE")
public class SenderReceiverInterface {
    ...
    protected ArrayList<VariableDataPrototype> dataElements;
...
@XmlElement(name="VARIABLE-DATA-PROTOTYPE")
    public ArrayList<VariableDataPrototype> getDataElements() {
    return this.dataElements;
}

    public void setDataElements(ArrayList<VariableDataPrototype> value) {
        this.dataElements = value;
    }
    
    
    
    @XmlElementWrapper(name="INVALIDATION-POLICYS")
