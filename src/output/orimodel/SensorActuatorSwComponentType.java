...
@XmlRootElement(name = "SENSOR-ACTUATOR-SW-COMPONENT-TYPE")
public class SensorActuatorSwComponentType {
    ...
    protected SensorActuatorRef sensorActuatorRef;
...
@XmlElement(name="SWC-INTERNAL-BEHAVIOR")
    ...
    @XmlElement(name="SENSOR-ACTUATOR-REF")
    public SensorActuatorRef getSensorActuatorRef() {
    return this.sensorActuatorRef;
}

    public void setSensorActuatorRef(SensorActuatorRef value) {
        this.sensorActuatorRef = value;
    }
