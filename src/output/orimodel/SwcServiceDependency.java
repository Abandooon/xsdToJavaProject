...
@XmlRootElement(name = "SWC-SERVICE-DEPENDENCY")
public class SwcServiceDependency {
    ...
    protected ArrayList<RoleBasedPortAssignment> assignedPorts;
    
    
    
    protected RepresentedPortGroupRef representedPortGroupRef;
...
@XmlElement(name="ROLE-BASED-DATA-ASSIGNMENT")
    ...
    @XmlElementWrapper(name="ASSIGNED-PORTS")
@XmlElement(name="ROLE-BASED-PORT-ASSIGNMENT")
    public ArrayList<RoleBasedPortAssignment> getAssignedPorts() {
    return this.assignedPorts;
}

    public void setAssignedPorts(ArrayList<RoleBasedPortAssignment> value) {
    ...
    public RepresentedPortGroupRef getRepresentedPortGroupRef() {
    return this.representedPortGroupRef;
}

    public void setRepresentedPortGroupRef(RepresentedPortGroupRef value) {
