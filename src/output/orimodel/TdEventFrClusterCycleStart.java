...
@XmlRootElement(name = "TD-EVENT-FR-CLUSTER-CYCLE-START")
public class TdEventFrClusterCycleStart {
    ...
    protected FrClusterRef frClusterRef;
...
@XmlElement(name="ANNOTATION")
    ...
    public FrClusterRef getFrClusterRef() {
    return this.frClusterRef;
}

    public void setFrClusterRef(FrClusterRef value) {
