...
@XmlRootElement(name = "TD-EVENT-SWC-INTERNAL-BEHAVIOR-REFERENCE")
public class TdEventSwcInternalBehaviorReference {
    ...
    protected ReferencedTdEventSwcRef referencedTdEventSwcRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="REFERENCED-TD-EVENT-SWC-REF")
    public ReferencedTdEventSwcRef getReferencedTdEventSwcRef() {
    return this.referencedTdEventSwcRef;
}

    public void setReferencedTdEventSwcRef(ReferencedTdEventSwcRef value) {
        this.referencedTdEventSwcRef = value;
    }
