...
@XmlRootElement(name = "TD-EVENT-TT-CAN-CYCLE-START")
public class TdEventTtCanCycleStart {
    ...
    protected TtCanClusterRef ttCanClusterRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="TT-CAN-CLUSTER-REF")
    public TtCanClusterRef getTtCanClusterRef() {
    return this.ttCanClusterRef;
}

    public void setTtCanClusterRef(TtCanClusterRef value) {
        this.ttCanClusterRef = value;
    }
