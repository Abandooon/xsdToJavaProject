...
@XmlRootElement(name = "TD-EVENT-VFB-REFERENCE")
public class TdEventVfbReference {
    ...
    protected ReferencedTdEventVfbRef referencedTdEventVfbRef;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="REFERENCED-TD-EVENT-VFB-REF")
    public ReferencedTdEventVfbRef getReferencedTdEventVfbRef() {
    return this.referencedTdEventVfbRef;
}

    public void setReferencedTdEventVfbRef(ReferencedTdEventVfbRef value) {
        this.referencedTdEventVfbRef = value;
    }
