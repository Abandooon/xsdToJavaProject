...
@XmlRootElement(name = "USER-DEFINED-I-PDU")
public class UserDefinedIPdu {
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElement(name="CDD-TYPE")
    public String getCddType() {
    return this.cddType;
}

    public void setCddType(String value) {
        this.cddType = value;
    }
