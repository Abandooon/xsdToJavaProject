...
@XmlRootElement(name = "VARIABLE-AND-PARAMETER-INTERFACE-MAPPING")
public class VariableAndParameterInterfaceMapping {
    ...
    protected ArrayList<DataPrototypeMapping> dataMappings;
...
@XmlElement(name="ANNOTATION")
    ...
    @XmlElementWrapper(name="DATA-MAPPINGS")
@XmlElement(name="DATA-PROTOTYPE-MAPPING")
    public ArrayList<DataPrototypeMapping> getDataMappings() {
    return this.dataMappings;
}

    public void setDataMappings(ArrayList<DataPrototypeMapping> value) {
